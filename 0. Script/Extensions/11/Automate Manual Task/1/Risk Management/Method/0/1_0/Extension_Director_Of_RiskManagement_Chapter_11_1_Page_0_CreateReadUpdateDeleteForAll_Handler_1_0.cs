...
namespace BaseDI.Professional.Script.Risk_Management.Extensions_0
{
    public class Extension_Director_Of_RiskManagement_Chapter_11_1_Page_0_CreateReadUpdateDeleteForAll_Handler_1_0
    {
        ...
        public static Exception Step_X_X_Custom_Control_AppException_1_0(SingleParmPoco_12_2_1_0 input)
        {
            #region 1. INPUTS     

            #region MEMORIZE client/server instance

            _storedClientORserverInstance = input.Parameters["StoredClientOrServerInstance"];
            ...
            _storedExceptionDetails = input.Parameters["StoredMistakes"];

            #endregion

            #region MEMORIZE extra data

            _storedExtraData = input.Parameters["StoredExtraData"];
