...
export namespace BaseDI.BackEnd.Programming.Extensions_1
{
    ...
    {      
        ...
        public static Step_X_X_Custom_Store_RequestRoutes_1_0(data:object): Array<string> {
            ...
            const businessLogicMetaData: any = Extension_ProgrammingStudioAdministrator_MasterLeader_12_2_1_0.BaseDI.BackEnd.Programming.Extensions_1.Extension_ProgrammingStudioAdministrator_MasterLeader_12_2_1_0.Step_X_X_Read_And_FindJSONNode(data, "key_1", "Request", false);
