...
export namespace BaseDI.Professional.Programming.Extensions_1
{
    export class Extension_ProgrammingStudioAdministrator_MasterLeader_12_2_1_0
    {
        ...
        //metaDataCalledByEntryPointName: string, metaDataCalledByMethodName: string, metaDataCalledByMethodReason: string, mistakeDetailsTemplate: string
        public static async Step_X_X_Create_A_MistakeJsonNode_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<string>
        {
            //#region 1. INPUTS
            ...
            storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Step_X_X_Create_A_MistakeJsonNode_1_0");
        ...
        //metaDataCalledByEntryPointName: string, metaDataCalledByMethodName: string, metaDataCalledByMethodReason: string, presentationTemplate: string, businessTemplate: string, serviceTemplate: string, securityTemplate: string, dataTemplate: string
        public static async Step_X_X_Create_An_ObservationJsonNode_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<string> {
            //#region 1. INPUTS
            ...
            storedDeveloperLoggingInputs.Parameters.setValue("parameterClientOrServerInstance", this._storedClientOrServerInstance);
            storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "Extension_ProgrammingStudioAdministrator_MasterLeader_12_2_1_0.ts");
            storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Step_X_X_Create_An_ObservationJsonNode_1_0");
        ...
        public static async Step_X_X_Read_And_FindJSONNode_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<any>
        {
            //#region 1. Inputs
            ...
            storedDeveloperLoggingInputs.Parameters.setValue("parameterClientOrServerInstance", this._storedClientOrServerInstance);
            storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "Extension_ProgrammingStudioAdministrator_MasterLeader_12_2_1_0.ts");
            storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Step_X_X_Read_And_FindJSONNode_1_0");
            ...
            let storedData = parameterInputs.Parameters.getValue("parameterData");
            ...
            const ExecuteConversionRequest = async (parameterSearchData: any, parameterDataFilteredData:any, parameterSearchFilter: string, parameterSearchKeyValue: string) : any =>
            {
                _3rdParty_ObjectScan_ObjectSearcher([parameterSearchFilter],
                    {
                        filterFn: (key, value, { parameterParents }) => {
                            if (parameterSearchKeyValue) {
                                if (value === parameterSearchKeyValue) {
                                    parameterDataFilteredData = parameterParents[0];
                                }
                            }
                            else {
                                parameterDataFilteredData = parameterParents[0];
                        ...
                        breakFn: () => parameterDataFilteredData !== null
                    })(parameterSearchData);

                return parameterDataFilteredData;
            }
        ...
        public static async Step_X_X_Read_And_FindJSONNode_2_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0) {
