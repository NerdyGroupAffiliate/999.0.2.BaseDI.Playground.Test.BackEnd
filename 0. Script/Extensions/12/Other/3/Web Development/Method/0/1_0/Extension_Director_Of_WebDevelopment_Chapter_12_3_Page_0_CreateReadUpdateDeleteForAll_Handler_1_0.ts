...
export namespace BaseDI.Professional.Web_Development.Extensions_0 {
    export class Extension_Director_Of_WebDevelopment_Chapter_12_3_Page_0_CreateReadUpdateDeleteForAll_Handler_1_0 {
        ...
        public static async Step_X_X_Custom_Store_HTMLStructureToString_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<string>
        {
            ...
            const ExecuteStorageRequest = async (parameterHtmlBaseDIScriptName: string, parameterHtmlScripts: string, parameterCentralizedStorer: aClass_Programming_ScriptAction_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>, parameterClientOrServerInstance: Object, parameterStorylineDetails: Object, parameterDataResponse: any) : Promise<string> => {
                ...
                {                   
                    ...
                    parameterDataResponse = await Extension_Director_Of_Programming_Chapter_12_2_Page_3_Request_Storage_1_0.BaseDI.Professional.Programming.Extensions_3.Extension_Director_Of_Programming_Chapter_12_2_Page_3_Request_Storage_1_0.Step_X_X_Custom_Control_LocalDataToServerMemory_1_0(storedParameterInputs);
            ...
            const ExecuteConversionRequest = async (parameterHtmlPageTemplate: string, parameterHtmlMetaData: string, parameterHtmlTitle: string, parameterHtmlScripts: string, parameterHtmlStyles: string, parameterHtmlBody: string) => {
            ...
            const ExecuteConversionRequest = async (parameterHtmlAttributes: any, parameterHtmlAttributesOutput: Array<any>): Promise<any> => {
                try
                {
                    ...
                    if (storedDeveloperMode) {
                        ...
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterMessageType", "Mistake"); //Values = Logging or Mistake
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterStepNumberReplace", storedClientOrServerInstance["processStepNumber"]);
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Step_0_0_Custom_Store_HTMLAttributesToArray_1_0.ExecuteConversionRequest");
        ...
        public static async Step_2_0_Custom_Convert_HTMLRowsJSONtoHTML_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<string>
        {
            //#region 1. INPUTS
            ...
            const ExecuteConversionRequest = async (parameterHtmlContainerString: string, parameterHtmlRowsJSON: any, parameterDataResponseList: Array<any>): Promise<string> => {
                try
                {
                    parameterHtmlRowsJSON.value.HTMLContentItems.forEach(storedHtmlRow => {
                        parameterDataResponseList.push(`<${storedHtmlRow.Tag} ${this.Step_0_0_Custom_Store_HTMLAttributesToArray_1_0(storedHtmlRow.Attributes)}>{${storedHtmlRow.Attributes[0].id}_Replace}</${storedHtmlRow.Tag}>`)
                    });

                    return parameterHtmlContainerString.replace("{HTMLRows_Replace}", parameterDataResponseList.join("\n"))
                }
                catch (mistake)
                {
                    //#region EDGE CASE - USE developer logger
                    ...
                    if (storedDeveloperMode) {
                        ...
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterMessageType", "Mistake"); //Values = Logging or Mistake
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterStepNumberReplace", storedClientOrServerInstance["processStepNumber"]);
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Step_2_0_Custom_Convert_HTMLRowsJSONtoHTML_1_0.ExecuteConversionRequest");
        ...
        public static async Step_3_0_Custom_Convert_HTMLColumnsJSONtoHTML_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<string>
        {
            //#region 1. INPUTS
            ...
            storedDeveloperLoggingInputs.Parameters.setValue("parameterClientOrServerInstance", storedClientOrServerInstance);
            storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "Extension_Director_Of_WebDevelopment_Chapter_12_3_Page_0_CreateReadUpdateDeleteForAll_Handler_1_0.ts");
            storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Step_3_0_Custom_Convert_HTMLColumnsJSONtoHTML_1_0");
            ...
            const ExecuteConversionRequest = async (parameterHtmlRowString: string, parameterHtmlColumnsJSON: any, parameterColumnItem: string): Promise<string> => {
                try {
                    parameterHtmlColumnsJSON.value.HTMLContentItems.forEach(storedHtmlColumn => {
                        parameterColumnItem = `<${storedHtmlColumn.Tag} ${this.Step_0_0_Custom_Store_HTMLAttributesToArray_1_0(storedHtmlColumn.Attributes)}>{${storedHtmlColumn.Attributes[0].id}_Replace}</${storedHtmlColumn.Tag}>\n`;
                    ...
                    if (storedDeveloperMode) {
                        ...
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterMessageType", "Mistake"); //Values = Logging or Mistake
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterStepNumberReplace", storedClientOrServerInstance["processStepNumber"]);
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Step_3_0_Custom_Convert_HTMLColumnsJSONtoHTML_1_0.ExecuteConversionRequest");
        ...
        public static async Step_4_0_Custom_Convert_HTMLContentJSONtoHTML_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<string>
        {
            //#region 1. INPUTS
            ...
            const ValidateInputs = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0) => {
                ...
                storedDeveloperLoggingInputs.Parameters.setValue("parameterClientOrServerInstance", storedClientOrServerInstance);
                storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "Extension_Director_Of_Programming_Chapter_12_2_Page_3_Request_Storage_1_0.ts");
                storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Step_4_0_Custom_Convert_HTMLContentJSONtoHTML_1_0.ValidateInputs()");
            ...
            storedDeveloperLoggingInputs.Parameters.setValue("parameterClientOrServerInstance", storedClientOrServerInstance);
            storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "Extension_Director_Of_WebDevelopment_Chapter_12_3_Page_0_CreateReadUpdateDeleteForAll_Handler_1_0.ts");
            storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Step_4_0_Custom_Convert_HTMLContentJSONtoHTML_1_0");
            ...
            const ExecuteConversionRequest = async (parameterHtmlColumnString: string, parameterHtmlContentJSON: any, parameterDataResponseIdsAndContent: Array<any>, parameterContent: any): Promise<string> => {
                try {
                    parameterHtmlContentJSON.value.HTMLContentItems.forEach(storedHtmlContent => {
                        if (parameterDataResponseIdsAndContent[storedHtmlContent.ParentHTMLContentItemAttributeID] == undefined) {
                            parameterDataResponseIdsAndContent[storedHtmlContent.ParentHTMLContentItemAttributeID] = new Array();
                            parameterDataResponseIdsAndContent[storedHtmlContent.ParentHTMLContentItemAttributeID].push(`<${storedHtmlContent.Tag} ${this.Step_0_0_Custom_Store_HTMLAttributesToArray_1_0(storedHtmlContent.Attributes)}>${storedHtmlContent.Value}</${storedHtmlContent.Tag}>\n`);
                        }
                        else {
                            parameterDataResponseIdsAndContent[storedHtmlContent.ParentHTMLContentItemAttributeID].push(`<${storedHtmlContent.Tag} ${this.Step_0_0_Custom_Store_HTMLAttributesToArray_1_0(storedHtmlContent.Attributes)}>${storedHtmlContent.Value}</${storedHtmlContent.Tag}>\n`);
                        }
                    ...
                    Object.keys(parameterDataResponseIdsAndContent).forEach(storedIdAndContentItem => {
                        parameterContent = parameterDataResponseIdsAndContent[storedIdAndContentItem].join('\n')
                    ...
                    if (storedDeveloperMode) {
                        ...
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterMessageType", "Mistake"); //Values = Logging or Mistake
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterStepNumberReplace", storedClientOrServerInstance["processStepNumber"]);
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Step_4_0_Custom_Convert_HTMLContentJSONtoHTML_1_0.ExecuteConversionRequest");
        ...
        public static async Step_5_0_Custom_Convert_CSSJSONToInlineStyles_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<string>
        {
            //#region 1. INPUTS
            ...
            storedDeveloperLoggingInputs.Parameters.setValue("parameterClientOrServerInstance", storedClientOrServerInstance);
            storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "Extension_Director_Of_WebDevelopment_Chapter_12_3_Page_0_CreateReadUpdateDeleteForAll_Handler_1_0.ts");
            storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Step_5_0_Custom_Convert_CSSJSONToInlineStyles_1_0");
            ...
            const ExecuteConversionRequest = async (): Promise<string> => {
                ...
                catch (mistake)
                {
                    ...
                    if (storedDeveloperMode) {
                        ...
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterMessageType", "Mistake"); //Values = Logging or Mistake
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterStepNumberReplace", storedClientOrServerInstance["processStepNumber"]);
                        storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Step_5_0_Custom_Convert_CSSJSONToInlineStyles_1_0.ExecuteConversionRequest");
