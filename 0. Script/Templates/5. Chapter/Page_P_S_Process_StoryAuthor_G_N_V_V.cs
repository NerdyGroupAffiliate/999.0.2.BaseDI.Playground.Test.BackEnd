...
namespace BaseDI.Professional.Chapter.Page.NICHE_X
{
    public class Page_P_S_Process_StoryAuthor_G_N_V_V : aClass_Programming_ScriptPage_12_2_1_0
    {
        ...
        public override async Task<JObject> Action()
        {
            ...
            storedProcessRequestDeveloperLoggingInputs.Parameters.TryAdd("parameterProcessRequestFileName", "{DirectorOrExperienceName} -> Page_P_S_Process_StoryAuthor_G_N_V_V.cs");
