...
//using BaseDI.Professional.Script.{NN}_{X};
...
//using ChapterPage = BaseDI.Professional.Chapter.Page.{NN}_{X};
...
namespace BaseDI.Professional.Director.NICHE_X
{
    public class Director_Of_NICHE_Chapter_G_N_Page_P_DESCRIPTION_Handler_V_V : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        ...
        public override async Task<JObject> Action()
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.TryAdd("parameterProcessRequestFileName", "Director_Of_NICHE_Chapter_G_N_Page_P_DESCRIPTION_Handler_V_V.cs");
