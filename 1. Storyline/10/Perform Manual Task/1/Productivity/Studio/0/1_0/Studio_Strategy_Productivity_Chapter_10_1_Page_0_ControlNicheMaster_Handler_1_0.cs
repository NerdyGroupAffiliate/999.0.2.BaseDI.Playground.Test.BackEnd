...
namespace BaseDI.Professional.Story.Productivity_0
{
    #region 6. Action Implementation

    //A. Story in motion (DO SOMETHING) ACTING
    internal class Studio_Strategy_Productivity_Chapter_10_1_Page_0_ControlNicheMaster_Handler : aClass_Programming_ScriptNicheMaster_12_2_1_0<object>
    {
        #region 1. Assign
        ...
        internal Studio_Strategy_Productivity_Chapter_10_1_Page_0_ControlNicheMaster_Handler(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        public override object Action(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.TryAdd("parameterProcessRequestFileName", "Studio_Strategy_Productivity_Chapter_10_1_Page_0_ControlNicheMaster_Handler_1_0.ts");
            ...
            storedProcessRequestDeveloperLoggingInputs.Parameters.TryAdd("parameterProcessRequestFileName", "Studio_Strategy_Productivity_Chapter_10_1_Page_0_ControlNicheMaster_Handler_1_0.cs");
        ...
        private object Create_Director_Of_Productivity_Chapter_10_1_Page_1_XXXXXX_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
            ...
            aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0 storedProcessRequestHandlerDirector = null;//new Director_Of_Productivity_Chapter_1_1_Page_1_XXXXXX_1_0(parameterInputs);
            ...
            storedProcessRequestDeveloperLoggingInputs.Parameters.TryAdd("parameterProcessRequestMethodName", "Studio_Strategy_Productivity_Chapter_10_1_Page_0_ControlNicheMaster_Handler_1_0");
            ...
            {
                case "LOCAL_FILE":
                    storedProcessRequestHandlerDirector.Repository = null; //new LocalFile_Director_Of_Productivity_Chapter_1_1_Page_1_XXXXXX_1_0(parameterInputs);
                    storedProcessRequestHandlerDirector.Repository.RequestName = _storedProcessRequestName;

                    break;
                case "REMOTE_SERVICE":
                    storedProcessRequestHandlerDirector.Repository = null; //new RemoteService_Director_Of_Productivity_Chapter_1_1_Page_1_XXXXXX_1_0(parameterInputs);
                    storedProcessRequestHandlerDirector.Repository.RequestName = _storedProcessRequestName;
