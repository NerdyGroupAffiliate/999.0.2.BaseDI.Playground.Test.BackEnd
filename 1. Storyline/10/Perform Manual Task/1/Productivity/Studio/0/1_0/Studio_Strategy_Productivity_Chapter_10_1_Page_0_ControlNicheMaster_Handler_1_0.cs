...
namespace BaseDI.Professional.Story.Productivity_0
{
    ...
    internal class Studio_Strategy_Productivity_Chapter_10_1_Page_0_ControlNicheMaster_Handler : aClass_Programming_ScriptNicheMaster_12_2_1_0<object>
    {
        ...
        private object Create_Director_Of_Productivity_Chapter_10_1_Page_1_XXXXXX_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            ...
            aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0 storedProcessRequestHandler_Director = null;//new Director_Of_Productivity_Chapter_1_1_Page_1_XXXXXX_1_0(parameterInputs);
            ...
            {
                case "LOCAL_FILE":
                    storedProcessRequestHandler_Director.Repository = null; //new LocalFile_Director_Of_Productivity_Chapter_1_1_Page_1_XXXXXX_1_0(parameterInputs);
                    storedProcessRequestHandler_Director.Repository.RequestName = _storedProcessRequestName;

                    break;
                case "REMOTE_SERVICE":
                    storedProcessRequestHandler_Director.Repository = null; //new RemoteService_Director_Of_Productivity_Chapter_1_1_Page_1_XXXXXX_1_0(parameterInputs);
                    storedProcessRequestHandler_Director.Repository.RequestName = _storedProcessRequestName;
