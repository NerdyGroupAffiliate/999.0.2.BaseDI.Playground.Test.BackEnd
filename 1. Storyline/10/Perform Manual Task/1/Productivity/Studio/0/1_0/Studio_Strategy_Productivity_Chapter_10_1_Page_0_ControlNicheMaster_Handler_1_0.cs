...
namespace BaseDI.Professional.Story.Productivity_1
{
    ...
    internal class Studio_Strategy_Productivity_Chapter_10_1_Page_0_ControlNicheMaster_Handler : aClass_Programming_ScriptNicheMaster_12_2_1_0<object>
    {
        ...
        public override async Task<object> Action(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            ...
            try
            {
                ...
                switch (storedClientRequestByName.ToUpper())
                {
                    ...
                    //    storedRequestHandler = Create_Director_Of_Productivity_Chapter_10_1_Page_1_XXXXXX_1_0(storylineDetails, storylineDetails_Parameters, this._extraData);
        ...
        private object Create_Director_Of_Productivity_Chapter_10_1_Page_1_XXXXXX_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            ...
            string storedRepositoryType = !string.IsNullOrEmpty(_storedProcessRequestSettings.GetValue<string>("AppSettings:APP_SETTING_CONVERSION_MODE_10_1_PRODUCTIVITY_NICHE_MASTER")) ? _storedProcessRequestSettings.GetValue<string>("AppSettings:APP_SETTING_CONVERSION_MODE_10_1_PRODUCTIVITY_NICHE_MASTER") : "LOCAL_FILE";
            ...
            storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestTracker", _storedProcessRequestTracker);
            storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestFileName", "Studio_Strategy_Productivity_Chapter_10_1_Page_0_ControlNicheMaster_Handler.cs");
            storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestMethodName", "Create_Director_Of_Productivity_Chapter_1_1_Page_1_XXXXXX_1_0");
            ...
            aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0 storedRequestHandler_Director = null;//new Director_Of_Productivity_Chapter_1_1_Page_1_XXXXXX_1_0(parameterInputs);
            ...
            {
                case "LOCAL_FILE":
                    storedRequestHandler_Director.Repository = null; //new LocalFile_Director_Of_Productivity_Chapter_1_1_Page_1_XXXXXX_1_0(parameterInputs);
                    storedRequestHandler_Director.Repository.RequestName = _storedRequestName;

                    break;
                case "REMOTE_SERVICE":
                    storedRequestHandler_Director.Repository = null; //new RemoteService_Director_Of_Productivity_Chapter_1_1_Page_1_XXXXXX_1_0(parameterInputs);
                    storedRequestHandler_Director.Repository.RequestName = _storedRequestName;
