...
export namespace BaseDI.Professional.Story.Productivity_0 {
    export class Studio_Strategy_Productivity_Chapter_10_1_Page_0_ControlNicheMaster_Handler extends aClass_Programming_ScriptNicheMaster_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptNicheMaster_12_2_1_0<object>
    {
        //#region 1. Assign
        ...
        public async Action(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<object>
        {
            ...
            const ValidateInputs = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0) => {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestFileName", "Studio_Strategy_Productivity_Chapter_10_1_Page_0_ControlNicheMaster_Handler_1_0.ts");
            ...
            try
            {
                ...
                switch (storedInputRequestName.toUpperCase()) {
                    ...
                    //    storedProcessRequestHandler = this.Create_Director_Of_Productivity_Chapter_10_1_Page_1_XXXXXX_1_0(storylineDetails, storylineDetails_Parameters, this._extraData);
        ...
        //#region Page 1
        private Create_Director_Of_Productivity_Chapter_10_1_Page_1_XXXXXX_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): object {
            //#region 1. INPUTS
            ...
            let storedProcessRequestRepositoryType: string = this._storedProcessRequestSettings.APP_SETTING_CONVERSION_MODE_10_1_PRODUCTIVITY_NICHE_MASTER ? this._storedProcessRequestSettings.APP_SETTING_CONVERSION_MODE_10_1_PRODUCTIVITY_NICHE_MASTER : "LOCAL_FILE";
            ...
            switch (storedProcessRequestRepositoryType.toUpperCase()) {
                case "LOCAL_FILE":
                    storedProcessRequestHandlerDirector.Repository = null; //new LocalFile_Director_Of_Productivity_Chapter_10_1_Page_1_XXXXXX_1_0.BaseDI.Professional.State.Advertising_1.LocalFile_Director_Of_Advertising_Chapter_1_1_Page_1_InputAdvertisement_Handler_1_0(parameterInputs);
                    storedProcessRequestHandlerDirector.Repository.RequestName = this._storedProcessRequestName;

                    break;
                case "REMOTE_SERVICE":
                    storedProcessRequestHandlerDirector.Repository = null; //new RemoteService_Director_Of_Productivity_Chapter_10_1_Page_1_XXXXXX_1_0.BaseDI.Professional.State.Advertising_1.RemoteService_Director_Of_Advertising_Chapter_1_1_Page_1_InputAdvertisement_Handler_1_0(parameterInputs);
                    storedProcessRequestHandlerDirector.Repository.RequestName = this._storedProcessRequestName;
