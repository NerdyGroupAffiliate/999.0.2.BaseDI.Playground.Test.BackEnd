    ...
    export class CareersEmploymentFactoryImplementer_NicheMaster_12_1_1_0 extends aClass_Programming_ScriptNicheMaster_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptNicheMaster_12_2_1_0<object>
    {
        ...
        public async Action(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<object> {
            ...
            const ValidateInputs = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<boolean> => {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestFileName", "CareersEmploymentFactoryImplementer_NicheMaster_12_1_1_0.ts");
        ...
        private Create_Director_Of_CareersEmployment_Chapter_12_1_Page_1_XXXXXX_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): object {
            ...
            let storedProcessRequestHandler_Director = null; //new Director_Of_CareersEmployment_Chapter_12_1_Page_1_XXXXXX_1_0.BaseDI.Professional.Director.Advertising_1.Director_Of_Advertising_Chapter_1_1_Page_1_CreateAdvertisementForAll_Handler_1_0(parameterInputs);
            ...
            switch (storedProcessRequestRepositoryType.toUpperCase()) {
                case "LOCAL_FILE":
                    storedProcessRequestHandler_Director.Repository = null; //new LocalFile_Director_Of_CareersEmployment_Chapter_12_1_Page_1_XXXXXX_1_0.BaseDI.Professional.State.Advertising_1.LocalFile_Director_Of_Advertising_Chapter_1_1_Page_1_CreateAdvertisementForAll_Handler_1_0(parameterInputs);
                    storedProcessRequestHandler_Director.Repository.RequestName = this._storedProcessRequestName;

                    break;
                case "REMOTE_SERVICE":
                    storedProcessRequestHandler_Director.Repository = null; //new RemoteService_Director_Of_CareersEmployment_Chapter_12_1_Page_1_XXXXXX_1_0.BaseDI.Professional.State.Advertising_1.RemoteService_Director_Of_Advertising_Chapter_1_1_Page_1_CreateAdvertisementForAll_Handler_1_0(parameterInputs);
                    storedProcessRequestHandler_Director.Repository.RequestName = this._storedProcessRequestName;
