    ...
    export class CareersEmploymentFactoryImplementer_NicheMaster_12_1_1_0 extends aClass_Programming_ScriptNicheMaster_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptNicheMaster_12_2_1_0<object>
    {
        ...
        public async Action(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<object> {
            ...
            const ValidateInputs = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<boolean> => {
                ...
                storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "CareersEmploymentFactoryImplementer_NicheMaster_12_1_1_0.ts");
            ...
            try {
                ...
                switch (storedClientRequestByName.toUpperCase()) {
                    ...
                    //    storedRequestHandler = this.Create_Director_Of_CareersEmployment_Chapter_12_1_Page_1_XXXXXX_1_0(storylineDetails, storylineDetails_Parameters, this._extraData);
        ...
        private Create_Director_Of_CareersEmployment_Chapter_12_1_Page_1_XXXXXX_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): object {
            ...
            let storedRepositoryType: string = process.env.APP_SETTING_CONVERSION_MODE_12_1_CAREERSEMPLOYMENT_NICHE_MASTER ? process.env.APP_SETTING_CONVERSION_MODE_12_1_CAREERSEMPLOYMENT_NICHE_MASTER : "LOCAL_FILE";
            ...
            storedDeveloperLoggingInputs.Parameters.setValue("parameterClientOrServerInstance", this._storedClientOrServerInstance);
            storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "CareersEmploymentFactoryImplementer_NicheMaster_12_1_1_0.ts");
            storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Create_Director_Of_CareersEmployment_Chapter_12_1_Page_1_XXXXXX_1_0");
            ...
            let storedRequestHandler_Director = null; //new Director_Of_CareersEmployment_Chapter_12_1_Page_1_XXXXXX_1_0.BaseDI.Professional.Director.Advertising_1.Director_Of_Advertising_Chapter_1_1_Page_1_CreateAdvertisementForAll_Handler_1_0(parameterInputs);
            ...
            switch (storedRepositoryType.toUpperCase()) {
                case "LOCAL_FILE":
                    storedRequestHandler_Director.Repository = null; //new LocalFile_Director_Of_CareersEmployment_Chapter_12_1_Page_1_XXXXXX_1_0.BaseDI.Professional.State.Advertising_1.LocalFile_Director_Of_Advertising_Chapter_1_1_Page_1_CreateAdvertisementForAll_Handler_1_0(parameterInputs);
                    storedRequestHandler_Director.Repository.RequestName = this._storedRequestName;

                    break;
                case "REMOTE_SERVICE":
                    storedRequestHandler_Director.Repository = null; //new RemoteService_Director_Of_CareersEmployment_Chapter_12_1_Page_1_XXXXXX_1_0.BaseDI.Professional.State.Advertising_1.RemoteService_Director_Of_Advertising_Chapter_1_1_Page_1_CreateAdvertisementForAll_Handler_1_0(parameterInputs);
                    storedRequestHandler_Director.Repository.RequestName = this._storedRequestName;
