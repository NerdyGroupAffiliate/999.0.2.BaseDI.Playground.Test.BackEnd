...
namespace BaseDI.Professional.Story.CMS_1
{
    ...
    internal class CMSFactoryImplementer_NicheMaster_12_4_1_0 : aClass_Programming_ScriptNicheMaster_12_2_1_0<object>
    {
        ...
        internal CMSFactoryImplementer_NicheMaster_12_4_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        public override async Task<object> Action(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestFileName", "CMSFactoryImplementer_NicheMaster_12_4_1_0.cs");
        ...
        private object Create_Director_Of_CMS_Chapter_12_Page_1_XXXXXX_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            ...
            aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0 storedProcessRequestHandler_Director = null;//new Director_Of_CMS_Chapter_12_Page_1_XXXXXX_1_0(parameterInputs);
            ...
            {
                case "LOCAL_FILE":
                    storedProcessRequestHandler_Director.Repository = null; //new LocalFile_Director_Of_CMS_Chapter_12_Page_1_XXXXXX_1_0(parameterInputs);
                    storedProcessRequestHandler_Director.Repository.RequestName = _storedProcessRequestName;

                    break;
                case "REMOTE_SERVICE":
                    storedProcessRequestHandler_Director.Repository = null; //new RemoteService_Director_Of_CMS_Chapter_12_Page_1_XXXXXX_1_0(parameterInputs);
                    storedProcessRequestHandler_Director.Repository.RequestName = _storedProcessRequestName;
