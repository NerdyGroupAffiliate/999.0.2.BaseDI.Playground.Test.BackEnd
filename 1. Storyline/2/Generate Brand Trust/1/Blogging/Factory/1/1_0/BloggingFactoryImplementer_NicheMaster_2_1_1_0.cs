...
namespace BaseDI.Professional.Story.Blogging_1
{
    ...
    internal class BloggingFactoryImplementer_NicheMaster_2_1_1_0 : aClass_Programming_ScriptNicheMaster_12_2_1_0<object>
    {
        ...
        internal BloggingFactoryImplementer_NicheMaster_2_1_1_0(ExtraData_12_2_1_0 extraData)
        {
            //region 1. Assign
        ...
        private object Create_Director_Of_Programming_Chapter_12_2_Page_1_ReadApiRoute_1_0(JObject storylineDetails, JObject storylineDetails_Parameters, ExtraData_12_2_1_0 extraData)
        {
            ...
            string repositoryType = AppSettings.GetValue<string>("AppSettings:APP_SETTING_CONVERSION_MODE_2_1_BLOGGING_NICHE_MASTER"); 
            ...
            //Direct_Advertising_Chapter_1_1_Page_1_CreateAdvertisement_1_0 director = new Direct_Advertising_Chapter_1_1_Page_1_CreateAdvertisement_1_0();
            ...
            //{
            //    case "LOCAL_FILE":
            //        var localFile = new LocalFile_Direct_Advertising_Chapter_1_1_Page_1_CreateAdvertisement_1_0(storylineDetails);

            //        director.Repository = localFile;

            //        break;
            //    case "REMOTE_SERVICE":
            //        var remoteService = new RemoteService_Direct_Advertising_Chapter_1_1_Page_1_CreateAdvertisement_1_0(storylineDetails);
