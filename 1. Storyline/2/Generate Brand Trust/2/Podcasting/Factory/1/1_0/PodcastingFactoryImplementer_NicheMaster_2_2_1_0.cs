...
namespace BaseDI.Story.Podcasting_2
{
    ...
    internal class PodcastingFactoryImplementer_NicheMaster_2_2_1_0 : aClass_Programming_ScriptNicheMaster_12_2_1_0<object>
    {
        ...
        internal PodcastingFactoryImplementer_NicheMaster_2_2_1_0(ExtraData_12_2_1_0 extraData)
        {
            //region 1. Assign
        ...
        private object Create_Director_Of_Programming_Chapter_12_2_Page_1_ReadApiRoute_1_0(JObject storylineDetails, JObject storylineDetails_Parameters, ExtraData_12_2_1_0 extraData)
        {
            ...
            string repositoryType = AppSettings.GetValue<string>("AppSettings:APP_SETTING_CONVERSION_MODE_2_2_PODCASTING_NICHE_MASTER"); 
