...
namespace BaseDI.Professional.Story.Podcasting_2
{
    ...
    internal class Studio_AudienceTesting_Podcasting_Chapter_2_2_Page_0_ControlNicheMaster_Handler_1_0 : aClass_Programming_ScriptNicheMaster_12_2_1_0<object>
    {
        ...
        public override async Task<object> Action(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            ...
            try
            {
                ...
                switch (storedClientRequestByName.ToUpper())
                {
                    ...
                    //    storedRequestHandler = Create_Director_Of_Podcasting_Chapter_2_Page_1_XXXXXX_1_0(storylineDetails, storylineDetails_Parameters, this._extraData);
        ...
        private object Create_Director_Of_Podcasting_Chapter_2_Page_1_XXXXXX_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            ...
            {
                case "LOCAL_FILE":
                    storedRequestHandler_Director.Repository = null; //new LocalFile_Director_Of_Podcasting_Chapter_2_Page_1_XXXXXX_1_0(parameterInputs);
                    storedRequestHandler_Director.Repository.RequestName = _storedRequestName;

                    break;
                case "REMOTE_SERVICE":
                    storedRequestHandler_Director.Repository = null; //new RemoteService_Director_Of_Podcasting_Chapter_2_Page_1_XXXXXX_1_0(parameterInputs);
                    storedRequestHandler_Director.Repository.RequestName = _storedRequestName;
