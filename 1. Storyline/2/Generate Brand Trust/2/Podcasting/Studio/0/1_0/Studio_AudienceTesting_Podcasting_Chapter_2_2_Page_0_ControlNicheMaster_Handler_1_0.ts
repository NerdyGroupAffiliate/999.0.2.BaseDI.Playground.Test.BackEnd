...
export namespace BaseDI.Professional.Story.Podcasting_0 {
    export class Studio_AudienceTesting_Podcasting_Chapter_2_2_Page_0_ControlNicheMaster_Handler_1_0 extends aClass_Programming_ScriptNicheMaster_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptNicheMaster_12_2_1_0<object>
    {
        ...
        private Create_Director_Of_Podcasting_Chapter_2_Page_1_XXXXXX_1_0(parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): object {
            ...
            let storedProcessRequestHandler_Director = null; //new Director_Of_Podcasting_Chapter_2_Page_1_XXXXXX_1_0.BaseDI.Professional.Director.Advertising_1.Director_Of_Advertising_Chapter_1_1_Page_1_InputAdvertisement_Handler_1_0(parameterInputs);
            ...
            switch (storedRepositoryType.toUpperCase()) {
                case "LOCAL_FILE":
                    storedProcessRequestHandler_Director.Repository = null; //new LocalFile_Director_Of_Podcasting_Chapter_2_Page_1_XXXXXX_1_0.BaseDI.Professional.State.Advertising_1.LocalFile_Director_Of_Advertising_Chapter_1_1_Page_1_InputAdvertisement_Handler_1_0(parameterInputs);
                    storedProcessRequestHandler_Director.Repository.RequestName = this._storedProcessRequestName;

                    break;
                case "REMOTE_SERVICE":
                    storedProcessRequestHandler_Director.Repository = null; //new RemoteService_Director_Of_Podcasting_Chapter_2_Page_1_XXXXXX_1_0.BaseDI.Professional.State.Advertising_1.RemoteService_Director_Of_Advertising_Chapter_1_1_Page_1_InputAdvertisement_Handler_1_0(parameterInputs);
                    storedProcessRequestHandler_Director.Repository.RequestName = this._storedProcessRequestName;
