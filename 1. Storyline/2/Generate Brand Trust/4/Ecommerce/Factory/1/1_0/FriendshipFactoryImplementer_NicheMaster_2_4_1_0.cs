...
namespace BaseDI.Professional.Story.Friendship_4
{
    #region 6. Action Implementation

    //A. Story in motion (DO SOMETHING) ACTING
    internal class FriendshipFactoryImplementer_NicheMaster_2_4_1_0 : aClass_Programming_ScriptNicheMaster_12_2_1_0<object>
    {
        #region 1. Assign
        ...
        internal FriendshipFactoryImplementer_NicheMaster_2_4_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        public override async Task<object> Action(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestFileName", "FriendshipFactoryImplementer_NicheMaster_2_4_1_0.cs");
