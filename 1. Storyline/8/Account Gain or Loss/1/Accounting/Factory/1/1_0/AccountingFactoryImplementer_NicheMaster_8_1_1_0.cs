...
namespace BaseDI.Professional.Story.Accounting_1
{
    ...
    internal class AccountingFactoryImplementer_NicheMaster_8_1_1_0 : aClass_Programming_ScriptNicheMaster_12_2_1_0<object>
    {
        ...
        internal AccountingFactoryImplementer_NicheMaster_8_1_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        public override async Task<object> Action(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestFileName", "AccountingFactoryImplementer_NicheMaster_8_1_1_0.cs");
