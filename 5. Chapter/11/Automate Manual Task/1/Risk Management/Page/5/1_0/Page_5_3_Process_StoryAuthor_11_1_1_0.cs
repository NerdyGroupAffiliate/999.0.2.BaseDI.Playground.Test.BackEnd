...
namespace BaseDI.Professional.Chapter.Page.Risk_Management_5
{
    public class Page_5_3_Process_StoryAuthor_11_1_1_0 : aClass_Programming_ScriptPage_12_2_1_0
    {
        #region 1. Assign
        ...
        public Page_5_3_Process_StoryAuthor_11_1_1_0(JObject storylineDetails, aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>> repository)
        {
            #region 1. Assign
        ...
        public override async Task<JObject> Action()
        {
            ...
            //var detail = storylineDetails.StoryScenery.Location.Stage.Details.Where(d => d.Key.ToUpper() == "Page_2_1_PROCESS_LAYOUTCONTAINER").SingleOrDefault();
