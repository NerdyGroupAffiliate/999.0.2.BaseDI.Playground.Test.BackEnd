...
namespace BaseDI.Professional.Chapter.Page.Programming_1
{
    public class Page_1_1_Begin_Process_12_2_1_0 : aClass_Programming_ScriptPage_12_2_1_0
    {
        ...
        public Page_1_1_Begin_Process_12_2_1_0(JObject parameterStorylineDetails, aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>> parameterRepository)
        {
            #region 1. INPUTS
        ...
        public override async Task<JObject> Action()
        {
            ...
            try
            {
                if(StorylineDetails == null)
                {
                    ...
                    if (storedDeveloperMode)
                    {
                        ...
                        Console.WriteLine("STEP " + _storedClientORserverInstance["processStepNumber"] + " RETRIEVING request dataset");
                    }
            ...
            catch(Exception mistake)
            {
                ...
                if (storedDeveloperMode)
                {
                    ...
                    Console.WriteLine("STEP " + _storedClientORserverInstance["processStepNumber"] + " ***LEAKY PIPE*** DATA RETRIVAL for request " + storedRequestName + " could not be completed successfully. Please check ***AppSettings.json*** for data retrival method.");
                }
