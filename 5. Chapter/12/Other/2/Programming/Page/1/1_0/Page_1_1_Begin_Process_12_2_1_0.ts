...
export namespace BaseDI.Professional.Chapter.Page.Programming_1
{
    export class Page_1_1_Begin_Process_12_2_1_0 extends aClass_Programming_ScriptPage_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptPage_12_2_1_0
    {
        ...
        public async Action(): Promise<object>
        {
            ...
            //REQUIRED
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequest3WordDescription", "RETRIEVING request dataset");
            ...
            try
            {
                if (this.StorylineDetails == null)
                {
                    ...
                    {
                        return new Studio_Automation_Programming_Chapter_12_2_Page_0_ControlMasterLeader_Handler_1_0_1_0.BaseDI.Professional.Story.Programming_1.Studio_Automation_Programming_Chapter_12_2_Page_0_ControlMasterLeader_Handler_1_0_1_0(new Director_Of_Programming_Chapter_12_2_Page_2_ConversionRequest_Handler_1_0.BaseDI.Professional.Director.Programming_2.Director_Of_Programming_Chapter_12_2_Page_2_ConversionRequest_Handler_1_0(this._storedParameterInputs))
                    ...
                    storedOutputResponseData = await GetDataResponse();
