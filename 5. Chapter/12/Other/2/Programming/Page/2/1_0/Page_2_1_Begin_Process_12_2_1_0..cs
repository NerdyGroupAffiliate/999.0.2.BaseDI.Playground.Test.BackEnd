...
namespace BaseDI.Professional.Chapter.Page.Programming_2
{
    public class Page_2_1_Begin_Process_12_2_1_0 : aClass_Programming_ScriptPage_12_2_1_0
    {
        ...
        private List<JToken> _storedProcessRequestJSONKeyPlaceHolderName;
        ...
        public Page_2_1_Begin_Process_12_2_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            ...
            Repository = parameterInputs.Parameters["parameterProcessRequestDataRepository"];
        ...
        public override async Task<JObject> Action()
        {
            ...
            storedProcessRequestDeveloperLoggingInputs.Parameters.TryAdd("parameterProcessRequestFileName", "Director_Of_Programming_Chapter_12_2_Page_2_ConversionRequest_Handler_1_0 -> Page_2_1_Begin_Process_12_2_1_0..cs");
            ...
            try
            {
                ...
                StorylineDetails = JObject.FromObject(storedOutputResponseData["storedProcessRequestDataStorylineDetails"]);
                StorylineDetails_Parameters = JObject.FromObject(storedOutputResponseData["storedProcessRequestDataStorylineDetails_Parameters"]);

                storedInputs = new SingleParmPoco_12_2_1_0();
                storedInputs.Parameters.TryAdd("parameterProcessRequestBaseDIJSONDataSchema", ((JObject)StorylineDetails.SelectToken("resources[*].baseDIProfiles[*]")));

                Step_1_0_Framework_Store_JSONStringPlaceHolder_1_0(storedInputs);
        ...
        private async Task<JObject> Step_1_0_Framework_Store_JSONStringPlaceHolder_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
            ...
            List<JToken> storedProcessRequestJSONValuesList = new List<JToken>();
            ...
            _storedProcessRequestSettings = (IConfiguration)_storedInputs.Parameters["parameterProcessRequestSettings"];

            #endregion

            #region MEMORIZE process request data

            JObject storedProcessRequestBaseDIJSONDataSchema = parameterInputs.Parameters["parameterProcessRequestBaseDIJSONDataSchema"];
            ...
            try
            {
                ...
                if (storedProcessRequestBaseDIJSONDataSchema != null)
                {
                    if (_storedProcessRequestJSONKeyPlaceHolderName == null)
                        _storedProcessRequestJSONKeyPlaceHolderName = new List<JToken>();

                    foreach (var storedProcessRequestJSONValue in storedProcessRequestBaseDIJSONDataSchema.Children())
                    {
                        storedProcessRequestJSONValuesList.Add(storedProcessRequestJSONValue);
                    };

                    foreach (var storedProcessRequestJSONValue in storedProcessRequestJSONValuesList)
                    {
                        JProperty optionItem = (JProperty)storedProcessRequestJSONValue;

                        if (((JProperty)storedProcessRequestJSONValue).Name.ToString().ToUpper().Contains("_DATASET_JSON"))
                        {
                            _storedProcessRequestJSONKeyPlaceHolderName.Add(optionItem);
                        }
                    }
                }
        ...
        private async void Step_2_0_Framework_Convert_JSONStringPlaceHolderIntoAppSettings_1_0()
        {
            #region 1. INPUTS
            ...
            try
            {
                ...
                if (_storedProcessRequestJSONKeyPlaceHolderName.Any())
                {
                    foreach (var profile in _storedProcessRequestJSONKeyPlaceHolderName)
                    {
                ...
                await Task.FromResult<JObject>(StorylineDetails).ConfigureAwait(true);
