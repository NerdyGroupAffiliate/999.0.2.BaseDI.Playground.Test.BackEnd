...
namespace BaseDI.Chapter.Page.Web_Development_1
{
    public class Page_1_5_Process_StorySetting_12_3_1_0 : aClass_Programming_ScriptPage_12_2_1_0
    {
        ...
        public Page_1_5_Process_StorySetting_12_3_1_0(JObject storylineDetails, aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>> repository)
        {
            #region 1. Assign
        ...
        public override async Task<JObject> Action()
        {
            ...
            htmlStylesJSON = styles.Count > 0 ? styles[0].Parent.Parent :  null;
