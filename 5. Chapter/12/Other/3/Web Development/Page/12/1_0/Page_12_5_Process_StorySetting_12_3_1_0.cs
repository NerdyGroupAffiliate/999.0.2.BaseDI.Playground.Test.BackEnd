...
namespace BaseDI.Professional.Chapter.Page.Web_Development_12
{
    public class Page_12_5_Process_StorySetting_12_3_1_0 : aClass_Programming_ScriptPage_12_2_1_0
    {
        ...
        private string _storedRequestFileName = "LocalFile_Director_Of_Advertising_Chapter_1_1_Page_12_CreateAdvertisement_Handler_1_0";
        ...
        public override async Task<JObject> Action()
        {
            ...
            string storedObservationItem = await Extension_Studio_Automation_Programming_Chapter_12_2_Page_0_ControlMasterLeader_Handler_1_0_1_0.Step_X_X_Framework_Output_JsonObservationNode_1_0(storedInputs);
            ...
            try
            {
                ...
                try
                {
                    Func<Task<string>> ExecuteConversionRequest = async () =>
                    {
                        ...
                        storedHtmlContainerJSON = Extension_Studio_Automation_Programming_Chapter_12_2_Page_0_ControlMasterLeader_Handler_1_0_1_0.Step_X_X_Framework_Convert_JsonDataSetToNodes_1_0(storedInputs).Result.SingleOrDefault().Parent.Parent;
                ...
                try
                {
                    Func<Task<string>> ExecuteConversionRequest = async () =>
                    {
                        ...
                        storedHtmlRowsJSON = Extension_Studio_Automation_Programming_Chapter_12_2_Page_0_ControlMasterLeader_Handler_1_0_1_0.Step_X_X_Framework_Convert_JsonDataSetToNodes_1_0(storedInputs).Result.SingleOrDefault().Parent.Parent;
                ...
                try
                {
                    Func<Task<string>> ExecuteConversionRequest = async () =>
                    {
                        ...
                        storedHtmlColumnsJSON = Extension_Studio_Automation_Programming_Chapter_12_2_Page_0_ControlMasterLeader_Handler_1_0_1_0.Step_X_X_Framework_Convert_JsonDataSetToNodes_1_0(storedInputs).Result.SingleOrDefault().Parent.Parent;
                ...
                try
                {
                    Func<Task<string>> ExecuteConversionRequest = async () =>
                    {
                        ...
                        storedHtmlContentJSON = Extension_Studio_Automation_Programming_Chapter_12_2_Page_0_ControlMasterLeader_Handler_1_0_1_0.Step_X_X_Framework_Convert_JsonDataSetToNodes_1_0(storedInputs).Result.SingleOrDefault().Parent.Parent;
                ...
                try
                {
                    Func<Task<string>> ExecuteConversionRequest = async () =>
                    {
                        ...
                        storedHtmlStylesFiltered  = Extension_Studio_Automation_Programming_Chapter_12_2_Page_0_ControlMasterLeader_Handler_1_0_1_0.Step_X_X_Framework_Convert_JsonDataSetToNodes_2_0(storedInputs).Result.SingleOrDefault();
