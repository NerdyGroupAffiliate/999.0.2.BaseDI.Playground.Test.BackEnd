...
export namespace BaseDI.Professional.Chapter.Page.Web_Development_8 {
    export class Page_8_5_Process_StorySetting_12_3_1_0 extends aClass_Programming_ScriptPage_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptPage_12_2_1_0 {
        ...
        public async Action(): Promise<object> {
            ...
            let storedStorageKey: string = "StorageKey_" + "Director_Of_WebDevelopment_Chapter_12_3_Page_8_ReadWebinarScreenForAll_Handler_1_0" + "-" + "Read-BaseDI_PresentationHTML_Content";
