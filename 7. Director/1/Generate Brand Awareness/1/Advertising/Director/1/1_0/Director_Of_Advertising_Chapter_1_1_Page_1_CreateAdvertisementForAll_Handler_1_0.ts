...
export namespace BaseDI.Professional.Director.Advertising_1
{
    export class Director_Of_Advertising_Chapter_1_1_Page_1_CreateAdvertisementForAll_Handler_1_0 extends aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        //#region 1. Assign
        ...
        public async Action(): Promise<object>
        {
            ...
            const ValidateInputs = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<boolean> =>
            {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestFileName", "Director_Of_Advertising_Chapter_1_1_Page_1_CreateAdvertisementForAll_Handler_1_0.ts");
            ...
            let storedProcessRequestHandler_UsingBuilderPattern: Use_DesignPattern_Builder_Chapter_1_1_Page_1 = null;
            ...
            try
            {
                ...
                storedProcessRequestHandler_UsingBuilderPattern = new Use_DesignPattern_Builder_Chapter_1_1_Page_1(this._storedInputs);
    ...
    export class Use_DesignPattern_Builder_Chapter_1_1_Page_1
    {
        //#region 1. Assign
        ...
        public async Action(): Promise<object> {
            ...
            storedProcessRequestHandler_UsingBuilderPattern = new Implement_DesignPattern_Builder_Chapter_1_1_Page_1_1_0(this._storedInputs);
    ...
    export class Implement_DesignPattern_Builder_Chapter_1_1_Page_1_1_0 extends aClass_Programming_ScriptAction_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>
    {
        //#region 1. Assign
        ...
        private _storedProcessRequestFileName: string = "Experience_The_Hear_OfTheAPIServer_Message_12_3_1_0";
        private _storedProcessRequestName: string = "";
        private _storedProcessRequestDataRepository: IContract_Programming_Repository_12_2_1_0;
        private _storedProcessRequestSystemRequestByName: string;
        ...
        public HandleDefaults(): void {
            ...
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestTracker", this._storedProcessRequestTracker);
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestFileName", "Director_Of_Advertising_Chapter_1_1_Page_1_CreateAdvertisementForAll_Handler_1_0.ts");
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestMethodName", "Implement_DesignPattern_Builder_Chapter_1_1_Page_1_1_0 -> HandleDefaults");
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterOutputResponseOPTIONALMiddleOfProcess", true);
        ...
        public async Action_5_Process_StorySetting(): Promise<object> {
            ...
            //storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestSettings", this._storedProcessRequestTracker["storedProcessRequestSettings"]);
            //storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestTracker", this._storedProcessRequestTracker);
            //storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestFileName", "Experience_The_Hear_OfTheAPIServer_Message_12_3_1_0.ts");
        ...
        private async Factory_Action_5_Process_StorySetting(): Promise<object> {
            ...
            //storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestFileName", "Experience_The_Hear_OfTheAPIServer_Message_12_3_1_0.cs");
