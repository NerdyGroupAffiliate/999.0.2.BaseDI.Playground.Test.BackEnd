...
export namespace BaseDI.Director.Advertising_2
{
    export class Director_Of_Advertising_Chapter_1_1_Page_2_CreateWhereAPersonBecameAwareOfTopic_Handler_1_0 extends aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0.BaseDI.Programming.Abstract_1.aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0 {
        //#region 1. Assign
    ...
    export class Implement_DesignPattern_Builder_Chapter_1_1_Page_2_1_0 extends aClass_Programming_ScriptAction_12_2_1_0.BaseDI.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>
    {
        //#region 1. Assign
        private _centralizedStorer: aClass_Programming_ScriptAction_12_2_1_0.BaseDI.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>;
        private _centralizedDisturber: aClass_Programming_ScriptAction_12_2_1_0.BaseDI.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>;
        ...
        public async Action_1_Begin_Process(): Promise<object> {
            var page = new ChapterPage_Page_2_1_Begin_Process_1_2_1_0.BaseDI.Chapter.Page.Advertising_2.Page_2_1_Begin_Process_1_2_1_0(this._storylineDetails, this._repository);
        ...
        public async Action_6_Process_StoryExperiences(): Promise<object> {
            var page = new ChapterPage_Page_2_6_Process_StoryExperiences_1_2_1_0.BaseDI.Chapter.Page.Advertising_2.Page_2_6_Process_StoryExperiences_1_2_1_0(this._storylineDetails, this._repository);
        ...
        public async Action_9_Verify_Process(): Promise<object> {
            var page = new ChapterPage_Page_2_9_Verify_Process_1_2_1_0.BaseDI.Chapter.Page.Advertising_2.Page_2_9_Verify_Process_1_2_1_0(this._storylineDetails, this._repository);
