...
namespace BaseDI.Playground.Test.Backend.Director.Advertising_3
{   
    public class Director_Of_Advertising_Chapter_1_1_Page_3_CreateWhichTopicAPersonIsAwareOf_Handler_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        ...
        public Director_Of_Advertising_Chapter_1_1_Page_3_CreateWhichTopicAPersonIsAwareOf_Handler_1_0()
        {
            #region 1. Assign            
        ...
        public override async Task<JObject> Action()
        {
            ...
            Use_DesignPattern_Builder_Chapter_1_1_Page_3 designPattern = new Use_DesignPattern_Builder_Chapter_1_1_Page_3(Client, MasterLeader, StorylineDetails, StorylineDetails_Parameters, (IContract_Programming_Repository_12_2_1_0)Repository, ExtraData, EntryPoint);
    ...
    internal class Use_DesignPattern_Builder_Chapter_1_1_Page_3
    {
        ...
        internal Use_DesignPattern_Builder_Chapter_1_1_Page_3(object client, object centralizedMaster, JObject storylineDetails, JObject storylineDetails_Parameters, IContract_Programming_Repository_12_2_1_0 repository, ExtraData_12_2_1_0 extraData, aClass_Programming_ScriptRoutable_12_2_1_0 entryPoint = null)
        {
            _client = client;
        ...
        internal async Task<JObject> Action()
        {
            ...
            var builder = new Implement_DesignPattern_Builder_Chapter_1_1_Page_3_1_0(_client, _centralizedMaster, _storylineDetails, _storylineDetails_Parameters, _repository, _extraData, _entryPoint);
