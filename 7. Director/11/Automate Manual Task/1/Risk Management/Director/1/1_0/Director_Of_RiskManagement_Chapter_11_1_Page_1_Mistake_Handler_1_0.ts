...
export namespace BaseDI.Playground.Test.BackEnd.Director.Risk_Management_1
{
    ...
    export class Use_DesignPattern_Builder_Chapter_11_1_Page_1 {
        ...
        //#region 4. Action
        public async Action(): Promise<object> {
            const builder = new Implement_DesignPattern_Builder_Chapter_11_1_Page_1_1_0(this._client, this._centralizedMaster,this._storylineDetails, this._storylineDetails_Parameters, this._repository, this._extraData, this._entryPoint);
