...
using ChapterPage = BaseDI.Playground.Test.Backend.Chapter.Page.Risk_Management_2;
...
namespace BaseDI.Playground.Test.Backend.Director.Risk_Management_2
{
    public class Director_Of_RiskManagement_Chapter_11_1_Page_2_Backup_Handler_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        #region 1. Assign
        ...
        public Director_Of_RiskManagement_Chapter_11_1_Page_2_Backup_Handler_1_0()
        {
            #region 1. Assign            
    ...
    internal class Use_DesignPattern_Builder_Chapter_11_1_Page_2
    {
        ...
        internal async Task<JObject> Action()
        {
            ...
            var builder = new Implement_DesignPattern_Builder_Chapter_11_1_Page_2_1_0(_client, _centralizedMaster, _storylineDetails, _storylineDetails_Parameters, _repository, _extraData, _entryPoint);
