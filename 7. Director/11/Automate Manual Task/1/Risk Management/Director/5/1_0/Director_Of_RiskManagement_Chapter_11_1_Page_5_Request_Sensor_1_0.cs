...
using ChapterPage = BaseDI.Chapter.Page.Risk_Management_5;
...
namespace BaseDI.Director.Risk_Management_5
{
    public class Director_Of_RiskManagement_Chapter_11_1_Page_5_Request_Sensor_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        ...
        public Director_Of_RiskManagement_Chapter_11_1_Page_5_Request_Sensor_1_0()
        {
            #region 1. Assign            
        ...
        public override async Task<JObject> Action()
        {
            ...
            Use_DesignPattern_Builder_Chapter_12_2_Page_5 designPattern = new Use_DesignPattern_Builder_Chapter_12_2_Page_5(ClientOrServerInstance, MasterStorer, MasterDisturber, MasterSensor, StorylineDetails, StorylineDetails_Parameters, (aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>)Repository, ExtraData, EntryPoint);
    ...
    internal class Use_DesignPattern_Builder_Chapter_12_2_Page_5
    {
        #region 1. Assign
    ...
    internal class Implement_DesignPattern_Builder_Chapter_12_2_Page_5_1_0 : aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>
    {
        #region 1. Assign
        ...
        public override async Task<JObject> Action_1_Begin_Process()
        {
            ...
            var page = new ChapterPage.Page_5_1_Begin_Process_11_1_1_0(_storylineDetails, _repository);
        ...
        public override async Task<JObject> Action_2_Validate_Process()
        {
            ...
            var page = new ChapterPage.Page_5_2_Validate_Process_11_1_1_0(_storylineDetails, _repository);
        ...
        public override async Task<JObject> Action_3_Process_StoryAuthor()
        {
            ...
            var page = new ChapterPage.Page_5_3_Process_StoryAuthor_11_1_1_0(_storylineDetails, _repository);
        ...
        public override async Task<JObject> Action_4_Process_StoryCharacters()
        {
            ...
            var page = new ChapterPage.Page_5_4_Process_StoryCharacters_11_1_1_0(_storylineDetails, _repository);
        ...
        public override async Task<JObject> Action_5_Process_StorySetting()
        {
            ...
            var page = new ChapterPage.Page_5_5_Process_StorySetting_11_1_1_0(_storylineDetails, _repository);
        ...
        public override async Task<JObject> Action_6_Process_StoryExperiences()
        {
            ...
            var page = new ChapterPage.Page_5_6_Process_StoryExperiences_11_1_1_0(_storylineDetails, _repository);
        ...
        public override async Task<JObject> Action_7_Process_StoryResources()
        {
            ...
            var page = new ChapterPage.Page_5_7_Process_StoryResources_11_1_1_0(_storylineDetails, _repository);
        ...
        public override async Task<JObject> Action_8_Process_CRUD()
        {
            ...
            var page = new ChapterPage.Page_5_8_Process_CRUD_11_1_1_0(_storylineDetails, _repository);
        ...
        public override async Task<JObject> Action_9_Verify_Process()
        {
            ...
            var page = new ChapterPage.Page_5_9_Verify_Process_11_1_1_0(_storylineDetails, _repository);
