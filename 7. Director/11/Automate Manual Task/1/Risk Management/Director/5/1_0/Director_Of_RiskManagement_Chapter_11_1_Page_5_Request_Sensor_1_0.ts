...
export namespace BaseDI.BackEnd.Director.Risk_Management_5
{
    export class Director_Of_RiskManagement_Chapter_11_1_Page_5_Request_Sensor_1_0 extends aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0.BaseDI.BackEnd.Programming.Abstract_1.aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0 {
        ...
        public async Action(): Promise<object> {
            ...
            const designPattern = new Use_DesignPattern_Builder_Chapter_12_2_Page_5(this.Client, this.MasterStorer, this.MasterDisturber, this.MasterSensor, this.StorylineDetails, this.StorylineDetails_Parameters, this.Repository, this.ExtraData, this.EntryPoint)
            //#endregion
    ...
    export class Use_DesignPattern_Builder_Chapter_12_2_Page_5 {
        ...
        //#region 4. Action
        public async Action(): Promise<object> {
            const builder = new Implement_DesignPattern_Builder_Chapter_12_2_Page_5_1_0(this._client, this._centralizedStorer, this._centralizedDisturber, this._centralizedSensor, this._storylineDetails, this._storylineDetails_Parameters, this._repository, this._extraData, this._entryPoint);
