...
export namespace BaseDI.Professional.Director.Risk_Management_5
{
    export class Director_Of_RiskManagement_Chapter_11_1_Page_5_Request_Sensor_1_0 extends aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0 {
        //#region 1. Assign
    ...
    export class Use_DesignPattern_Builder_Chapter_12_2_Page_5 {
        ...
        //#region 4. Action
        public async Action(): Promise<object> {
            const builder = new Implement_DesignPattern_Builder_Chapter_12_2_Page_5_1_0(this._clientORserverInstance, this._centralizedStorer, this._centralizedDisturber, this._centralizedSensor, this._storylineDetails, this._storylineDetails_Parameters, this._repository, this._extraData, this._entryPoint);
