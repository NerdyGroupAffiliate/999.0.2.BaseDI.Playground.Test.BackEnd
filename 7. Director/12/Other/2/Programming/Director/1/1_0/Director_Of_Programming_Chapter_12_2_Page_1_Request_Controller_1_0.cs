...
namespace BaseDI.Professional.Director.Programming_1
{
    public class Director_Of_Programming_Chapter_12_2_Page_1_Request_Controller_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        ...
        public override async Task<JObject> Action()
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedDeveloperLoggingInputs.Parameters.Add("parameterFileName", "Director_Of_Programming_Chapter_12_2_Page_1_Request_Controller_1_0.cs");
            ...
            Use_DesignPattern_Builder_Chapter_12_2_Page_1 storedRequestHandler_UsingBuilderPattern = null;
            ...
            try
            {
                ...
                storedRequestHandler_UsingBuilderPattern = new Use_DesignPattern_Builder_Chapter_12_2_Page_1(_storedParameterInputs);
    ...
    internal class Use_DesignPattern_Builder_Chapter_12_2_Page_1
    {
        ...
        internal async Task<JObject> Action()
        {
            ...
            storedRequestHandler_UsingBuilderPattern = new Implement_DesignPattern_Builder_Chapter_12_2_Page_1_1_0(_storedParameterInputs);
    ...
    internal class Implement_DesignPattern_Builder_Chapter_12_2_Page_1_1_0 : aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>
    {
        ...
        private string _storedRequestFileName = "Director_Of_Programming_Chapter_12_2_Page_1_Request_Controller_1_0";
        private string _storedRequestName = "";
        private IContract_Programming_Repository_12_2_1_0 _storedRepository;
        private string _storedSystemRequestByName;
        ...
        public override async Task<JObject> Action_1_Begin_Process()
        {
            ...
            try
            {
                storedDataResponse = await Factory_Action_1_Begin_Process();
            }
            catch
            {
        ...
        public override async Task<JObject> Action_10_End_Process()
        {
            ...
            try
            {
                storedDataResponse = await Factory_Action_10_End_Process();
            }
            catch
            {
                throw; //Let "Startup.cs -> Startup_Controller" handle the exception.
        ...
        private async Task<JObject> Execute_Factory_Action_1_Begin_Process_StoreInputDataInMemory()
        {
            ...
            if (_storedBusinessDirectorOrExperienceRequestHandler == null)
            {
                var page = new ChapterPage.Page_1_1_Begin_Process_12_2_1_0(_storedParameterInputs);
        ...
        private async Task<JObject> Execute_Factory_Action_10_End_Process_TransportRequestToHandler()
        {
            ...
            var page = new ChapterPage.Page_1_10_End_Process_12_2_1_0(_storedParameterInputs);
