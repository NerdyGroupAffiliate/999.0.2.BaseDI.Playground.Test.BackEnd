...
namespace BaseDI.Professional.Director.Programming_1
{
    public class Director_Of_Programming_Chapter_12_2_Page_1_Request_Controller_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        ...
        public Director_Of_Programming_Chapter_12_2_Page_1_Request_Controller_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        public override async Task<JObject> Action()
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestFileName", "Director_Of_Programming_Chapter_12_2_Page_1_Request_Controller_1_0.cs");
            ...
            Use_DesignPattern_Builder_Chapter_12_2_Page_1 storedProcessRequestHandler_UsingBuilderPattern = null;
    ...
    internal class Use_DesignPattern_Builder_Chapter_12_2_Page_1
    {
        ...
        internal Use_DesignPattern_Builder_Chapter_12_2_Page_1(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
    ...
    internal class Implement_DesignPattern_Builder_Chapter_12_2_Page_1_1_0 : aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>
    {
        ...
        private async Task<JObject> Execute_Factory_Action_1_Begin_Process_StoreInputDataInMemory()
        {
            ...
            if (_storedProcessRequestBusinessDirectorOrExperienceRequestHandler == null)
            {
        ...
        //Page 1-10
        private async Task<JObject> Execute_Factory_Action_10_End_Process_TransportRequestToHandler()
        {
            #region 1. INPUTS
            ...
            var page = new ChapterPage.Page_1_10_End_Process_12_2_1_0(_storedInputs);
