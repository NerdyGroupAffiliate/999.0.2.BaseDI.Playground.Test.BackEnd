...
export namespace BaseDI.Professional.Director.Programming_1
{
    export class Director_Of_Programming_Chapter_12_2_Page_1_Request_Controller_1_0 extends aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        ...
        public async Action(): Promise<object>
        {
            ...
            const ValidateInputs = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<boolean> => {
                ...
                storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "Director_Of_Programming_Chapter_12_2_Page_1_Request_Controller_1_0.ts");
    ...
    export class Use_DesignPattern_Builder_Chapter_12_2_Page_1 {
        ...
        public async Action(): Promise<object> {
            ...
            storedRequestHandler_UsingBuilderPattern = new Implement_DesignPattern_Builder_Chapter_12_2_Page_1_1_0(this._storedParameterInputs);
    ...
    export class Implement_DesignPattern_Builder_Chapter_12_2_Page_1_1_0 extends aClass_Programming_ScriptAction_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>
    {
        ...
        public HandleDefaults(): void {
            ...
            storedDeveloperLoggingInputs.Parameters.setValue("parameterClientOrServerInstance", this._storedClientOrServerInstance);
            storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "Director_Of_Programming_Chapter_12_2_Page_1_Request_Controller_1_0.ts");
            storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Implement_DesignPattern_Builder_Chapter_12_2_Page_1_1_0 -> HandleDefaults");
            storedDeveloperLoggingInputs.Parameters.setValue("parameterOPTIONALMiddleOfProcess", true);
        ...
        public async Action_10_End_Process(): Promise<object>
        {
            ...
            try
            {
                storedDataResponse = await this.Factory_Action_10_End_Process();
            }
            catch (mistake)
            {
                throw mistake; //Let "Startup.ts" handle the exception.
        ...
        private async Factory_Action_10_End_Process(): Promise<object>
        {
            ...
            try {
                ...
                storedDataResponse = await this.Execute_Factory_Action_10_End_Process_TransportRequestToHandler();
        ...
        private async Execute_Factory_Action_1_Begin_Process_StoreInputDataInMemory(): Promise<object>
        {
            ...
            if (this._storedBusinessDirectorOrExperienceRequestHandler == null) {
                var page = new ChapterPage_Page_1_1_Begin_Process_12_2_1_0.BaseDI.Professional.Chapter.Page.Programming_1.Page_1_1_Begin_Process_12_2_1_0(this._storedParameterInputs);
        ...
        private async Execute_Factory_Action_10_End_Process_TransportRequestToHandler(): Promise<object>
        {
            ...
            //storedDeveloperLoggingInputs.Parameters.setValue("parameterClientOrServerInstance", _storedClientOrServerInstance);
            //storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "Director_Of_Programming_Chapter_12_2_Page_1_Request_Controller_1_0.cs");
            //storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Action -> Execute_Factory_Action_10_End_Process_TransportRequestToHandler -> Factory_Action_5_Process_StorySetting");
            ...
            var page = new ChapterPage_Page_1_10_End_Process_12_2_1_0.BaseDI.Professional.Chapter.Page.Programming_1.Page_1_10_End_Process_12_2_1_0(this._storedParameterInputs);
