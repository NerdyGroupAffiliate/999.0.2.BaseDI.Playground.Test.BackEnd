...
{
    public class Director_Of_Programming_Chapter_12_2_Page_2_ConversionRequest_Handler_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        #region 1. Assign
        ...
        public Director_Of_Programming_Chapter_12_2_Page_2_ConversionRequest_Handler_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        public override async Task<JObject> Action()
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.TryAdd("parameterProcessRequestFileName", "Director_Of_Programming_Chapter_12_2_Page_2_ConversionRequest_Handler_1_0.cs");
            ...
            Use_DesignPattern_Builder_Chapter_12_2_Page_2 storedProcessRequestHandler_UsingBuilderPattern = null;
            ...
            try
            {
                ...
                storedProcessRequestHandler_UsingBuilderPattern = new Use_DesignPattern_Builder_Chapter_12_2_Page_2(_storedInputs);
    ...
    internal class Use_DesignPattern_Builder_Chapter_12_2_Page_2
    {
        ...
        internal Use_DesignPattern_Builder_Chapter_12_2_Page_2(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        internal async Task<JObject> Action()
        {
            ...
            storedProcessRequestHandler_UsingBuilderPattern = new Implement_DesignPattern_Builder_Chapter_12_2_Page_1_1_0(_storedInputs);
    ...
    internal class Implement_DesignPattern_Builder_Chapter_12_2_Page_1_1_0 : aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>
    {
        ...
        internal Implement_DesignPattern_Builder_Chapter_12_2_Page_1_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        public override async Task<JObject> Action_1_Begin_Process()
        {
            ...
            try
            {
                storedOutputResponseData = await Factory_Action_1_Begin_Process();
            }
            catch
            {
        ...
        private async Task<JObject> Factory_Action_5_Process_StorySetting()
        {
            ...
            try
            {
                ...
                if (_storedInputRequestActionName.ToUpper() == Action_12_2_1_0._12_3_WEB_DEVELOPMENT_Server_Process_HtmlToJsonConversion_Request_1_0.ToUpper())
                {
                    storedOutputResponseData = await Execute_Action_5_Process_StorySetting_ProcessHtmlToJsonConversionRequest();
                }
        ...
        private async Task<JObject> Execute_Factory_Action_1_Begin_Process_StoreDataInCache()
        {
            ...
            var page = new ChapterPage.Page_2_1_Begin_Process_12_2_1_0(_storedInputs);
        ...
        //Page 1-5
        private async Task<JObject> Execute_Action_5_Process_StorySetting_ProcessHtmlToJsonConversionRequest()
        {
            #region 1. INPUTS
            ...
            var page = new ChapterPage.Page_2_5_Process_StorySetting_12_2_1_0(_storedInputs);
