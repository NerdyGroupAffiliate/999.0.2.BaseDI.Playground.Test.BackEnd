...
namespace BaseDI.Professional.Director.Programming_4
{
    public class Director_Of_Programming_Chapter_12_2_Page_4_Request_Disturbances_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        ...
        public override async Task<JObject> Action()
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedDeveloperLoggingInputs.Parameters.Add("parameterFileName", "Director_Of_Programming_Chapter_12_2_Page_4_Request_Disturbances_1_0.cs");
            ...
            Use_DesignPattern_Builder_Chapter_12_2_Page_4 storedRequestHandler_UsingBuilderPattern = null;
            ...
            try
            {
                ...
                if (DirectorOrExperienceRequestHandler != null && DirectorOrExperienceRequestHandler.ClientOrServerInstance != null)
                {
                    ...
                    _storedParameterInputs.Parameters.Add("parameterBusinessDirectorOrExperienceRequestHandler", DirectorOrExperienceRequestHandler);
                }

                //REQUIRED: Implement one of the design patterns at https://www.dofactory.com/net/design-patterns
                storedRequestHandler_UsingBuilderPattern = new Use_DesignPattern_Builder_Chapter_12_2_Page_4(_storedParameterInputs);
    ...
    internal class Use_DesignPattern_Builder_Chapter_12_2_Page_4
    {
        ...
        internal async Task<JObject> Action()
        {
            ...
            storedRequestHandler_UsingBuilderPattern = new Implement_DesignPattern_Builder_Chapter_12_2_Page_4_1_0(_storedParameterInputs);
    ...
    internal class Implement_DesignPattern_Builder_Chapter_12_2_Page_4_1_0 : aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>
    {
        ...
        private string _storedRequestFileName = "Director_Of_Programming_Chapter_12_2_Page_4_Request_Disturbances_1_0";
        private string _storedRequestName = "";
        private IContract_Programming_Repository_12_2_1_0 _storedRepository;
        private string _storedSystemRequestByName;
        ...
        public override async Task<JObject> Action_8_Process_CRUD()
        {
            ...
            //storedDeveloperLoggingInputs.Parameters.Add("parameterClientOrServerInstance", _storedClientOrServerInstance);
            //storedDeveloperLoggingInputs.Parameters.Add("parameterFileName", "Director_Of_Programming_Chapter_12_2_Page_4_Request_Disturbances_1_0.cs");
            //storedDeveloperLoggingInputs.Parameters.Add("parameterMethodName", "Action -> Action_8_Process_CRUD");
        ...
        private async Task<JObject> Execute_Factory_Action_8_Process_CRUD_StoreDataInCache()
        {
            ...
            //var page = new ChapterPage.Page_4_8_Process_CRUD_12_2_1_0(_storedParameterInputs);
        ...
        private async Task<JObject> Factory_Action_10_End_Process()
        {
            ...
            //storedDeveloperLoggingInputs.Parameters.Add("parameterAppSettings", _storedClientOrServerInstance["storedAppSettings"]);
            //storedDeveloperLoggingInputs.Parameters.Add("parameterClientOrServerInstance", _storedClientOrServerInstance);
            //storedDeveloperLoggingInputs.Parameters.Add("parameterFileName", "Director_Of_Programming_Chapter_12_2_Page_2_Request_Conversion_1_0.cs");         
