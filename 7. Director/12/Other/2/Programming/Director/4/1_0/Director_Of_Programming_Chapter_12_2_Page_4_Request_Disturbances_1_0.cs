...
namespace BaseDI.Professional.Director.Programming_4
{
    public class Director_Of_Programming_Chapter_12_2_Page_4_Request_Disturbances_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        ...
        public Director_Of_Programming_Chapter_12_2_Page_4_Request_Disturbances_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        public override async Task<JObject> Action()
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestFileName", "Director_Of_Programming_Chapter_12_2_Page_4_Request_Disturbances_1_0.cs");
    ...
    internal class Implement_DesignPattern_Builder_Chapter_12_2_Page_4_1_0 : aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>
    {
        ...
        private string _storedProcessRequestFileName = "Director_Of_Programming_Chapter_12_2_Page_4_Request_Disturbances_1_0";
        private string _storedProcessRequestName = "";
        private IContract_Programming_Repository_12_2_1_0 _storedProcessRequestDataRepository;
        private string _storedProcessRequestSystemRequestByName;
        ...
        private async Task<JObject> Execute_Factory_Action_8_Process_CRUD_StoreDataInCache()
        {
            ...
            //var page = new ChapterPage.Page_4_8_Process_CRUD_12_2_1_0(_storedInputs);
        ...
        private async Task<JObject> Factory_Action_10_End_Process()
        {
            ...
            //storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestSettings", _storedProcessRequestTracker["storedProcessRequestSettings"]);
            //storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestTracker", _storedProcessRequestTracker);
            //storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestFileName", "Director_Of_Programming_Chapter_12_2_Page_2_Request_Conversion_1_0.cs");         
