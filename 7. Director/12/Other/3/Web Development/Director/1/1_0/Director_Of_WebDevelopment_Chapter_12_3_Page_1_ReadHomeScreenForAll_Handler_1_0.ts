...
export namespace BaseDI.Professional.Director.Web_Development_1  {
    export class Director_Of_WebDevelopment_Chapter_12_3_Page_1_ReadHomeScreenForAll_Handler_1_0 extends aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0 {
        ...
        public async Action(): Promise<object> {
            ...
            const ValidateInputs = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<boolean> => {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestFileName", "Director_Of_WebDevelopment_Chapter_12_3_Page_1_ReadHomeScreenForAll_Handler_1_0.ts");
    ...
    export class Implement_DesignPattern_Builder_Chapter_12_3_Page_1_1_0 extends aClass_Programming_ScriptAction_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>
    {
        ...
        private _storedProcessRequestFileName: string = "Director_Of_WebDevelopment_Chapter_12_3_Page_1_ReadHomeScreenForAll_Handler_1_0";
        private _storedProcessRequestName: string = "";
        private _storedProcessRequestDataRepository: IContract_Programming_Repository_12_2_1_0;
        private _storedProcessRequestSystemRequestByName: string;
        ...
        public HandleDefaults(): void {
            ...
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestTracker", this._storedProcessRequestTracker);
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestFileName", "Director_Of_WebDevelopment_Chapter_12_3_Page_1_ReadHomeScreenForAll_Handler_1_0.ts");
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestMethodName", "Implement_DesignPattern_Builder_Chapter_12_3_Page_1_1_0 -> HandleDefaults");
            storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterOPTIONALMiddleOfProcess", true);
        ...
        public async Action_5_Process_StorySetting(): Promise<object>
        {
            ...
            //storedProcessRequestDeveloperLoggingInputs.Parameters.setValue("parameterProcessRequestFileName", "Director_Of_WebDevelopment_Chapter_12_3_Page_1_ReadHomeScreenForAll_Handler_1_0.cs");
        ...
        private async Execute_Factory_Action_5_Process_StorySetting_OutputHtml(): Promise<object> {
            ...
            var page = new ChapterPage_Page_1_5_Process_StorySetting_12_3_1_0.BaseDI.Professional.Chapter.Page.Web_Development_1.Page_1_5_Process_StorySetting_12_3_1_0(this._storedInputs);
