...
export namespace BaseDI.Professional.Director.Web_Development_11 {
    export class Director_Of_WebDevelopment_Chapter_12_3_Page_11_ReadOtherScreenForAll_Handler_1_0 extends aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0 {
        ...
        public async Action(): Promise<object> {
            ...
            const ValidateInputs = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<boolean> => {
                ...
                storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "Director_Of_WebDevelopment_Chapter_12_3_Page_11_ReadOtherScreenForAll_Handler_1_0.ts");
            ...
            let storedRequestHandler_UsingBuilderPattern: Use_DesignPattern_Builder_Chapter_12_3_Page_11 = null;
            ...
            const designPattern = new Use_DesignPattern_Builder_Chapter_12_3_Page_11(this.ClientOrServerInstance, this.MasterStorer, this.MasterDisturber, this.MasterSensor, this.StorylineDetails, this.StorylineDetails_Parameters, this.Repository, this.ExtraData, this.DirectorOrExperienceRequestHandler);
    ...
    export class Use_DesignPattern_Builder_Chapter_12_3_Page_11 {
        ...
        public async Action(): Promise<object> {
            ...
            storedRequestHandler_UsingBuilderPattern = new Implement_DesignPattern_Builder_Chapter_12_3_Page_11_1_0(this._storedParameterInputs);
    ...
    export class Implement_DesignPattern_Builder_Chapter_12_3_Page_11_1_0 extends aClass_Programming_ScriptAction_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>
    {
        ...
        private _storedRequestFileName: string = "Director_Of_WebDevelopment_Chapter_12_3_Page_11_ReadOtherScreenForAll_Handler_1_0";
        private _storedRequestName: string = "";
        private _storedRepository: IContract_Programming_Repository_12_2_1_0;
        private _storedSystemRequestByName: string;
        ...
        public HandleDefaults(): void {
            ...
            storedDeveloperLoggingInputs.Parameters.setValue("parameterClientOrServerInstance", this._storedClientOrServerInstance);
            storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "Director_Of_WebDevelopment_Chapter_12_3_Page_11_ReadOtherScreenForAll_Handler_1_0.ts");
            storedDeveloperLoggingInputs.Parameters.setValue("parameterMethodName", "Implement_DesignPattern_Builder_Chapter_12_3_Page_11_1_0 -> HandleDefaults");
            storedDeveloperLoggingInputs.Parameters.setValue("parameterOPTIONALMiddleOfProcess", true);
        ...
        public async Action_5_Process_StorySetting(): Promise<object> {
            ...
            //storedDeveloperLoggingInputs.Parameters.setValue("parameterFileName", "Director_Of_WebDevelopment_Chapter_12_3_Page_11_ReadOtherScreenForAll_Handler_1_0.cs");
        ...
        private async Execute_Factory_Action_5_Process_StorySetting_OutputHtml(): Promise<object> {
            ...
            var page = new ChapterPage_Page_11_5_Process_StorySetting_12_3_1_0.BaseDI.Professional.Chapter.Page.Web_Development_11.Page_11_5_Process_StorySetting_12_3_1_0(this._storedParameterInputs);
