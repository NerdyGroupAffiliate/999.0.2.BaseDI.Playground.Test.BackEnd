...
namespace BaseDI.Professional.Director.Web_Development_2
{
    public class Director_Of_WebDevelopment_Chapter_12_3_Page_2_ReadPresalesScreenForAll_Handler_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        ...
        public override async Task<JObject> Action()
        {
            ...
            Use_DesignPattern_Builder_Chapter_12_3_Page_2 designPattern = new Use_DesignPattern_Builder_Chapter_12_3_Page_2(ClientOrServerInstance, MasterLeader, StorylineDetails, StorylineDetails_Parameters, (aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>)Repository, ExtraData, EntryPoint);
