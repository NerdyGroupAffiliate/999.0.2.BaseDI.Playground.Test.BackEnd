...
import * as ChapterPage_Page_2_1_Begin_Process_12_3_1_0 from "../../../../../../../../5. Chapter/12/Other/3/Web Development/Page/2/1_0/Page_2_1_Begin_Process_12_3_1_0";
import * as ChapterPage_Page_2_2_Validate_Process_12_3_1_0 from "../../../../../../../../5. Chapter/12/Other/3/Web Development/Page/2/1_0/Page_2_2_Validate_Process_12_3_1_0";
import * as ChapterPage_Page_2_3_Process_StoryAuthor_12_3_1_0 from "../../../../../../../../5. Chapter/12/Other/3/Web Development/Page/2/1_0/Page_2_3_Process_StoryAuthor_12_3_1_0";
import * as ChapterPage_Page_2_4_Process_StoryCharacters_12_3_1_0 from "../../../../../../../../5. Chapter/12/Other/3/Web Development/Page/2/1_0/Page_2_4_Process_StoryCharacters_12_3_1_0";
import * as ChapterPage_Page_2_5_Process_StorySetting_12_3_1_0 from "../../../../../../../../5. Chapter/12/Other/3/Web Development/Page/2/1_0/Page_2_5_Process_StorySetting_12_3_1_0";
import * as ChapterPage_Page_2_6_Process_StoryExperiences_12_3_1_0 from "../../../../../../../../5. Chapter/12/Other/3/Web Development/Page/2/1_0/Page_2_6_Process_StoryExperiences_12_3_1_0";
import * as ChapterPage_Page_2_7_Process_StoryResources_12_3_1_0 from "../../../../../../../../5. Chapter/12/Other/3/Web Development/Page/2/1_0/Page_2_7_Process_StoryResources_12_3_1_0";
import * as ChapterPage_Page_2_8_Process_CRUD_12_3_1_0 from "../../../../../../../../5. Chapter/12/Other/3/Web Development/Page/2/1_0/Page_2_8_Process_CRUD_12_3_1_0";
import * as ChapterPage_Page_2_9_Verify_Process_12_3_1_0 from "../../../../../../../../5. Chapter/12/Other/3/Web Development/Page/2/1_0/Page_2_9_Verify_Process_12_3_1_0";
import * as ChapterPage_Page_2_10_End_Process_12_3_1_0 from "../../../../../../../../5. Chapter/12/Other/3/Web Development/Page/2/1_0/Page_2_10_End_Process_12_3_1_0";

export namespace BaseDI.Professional.Director.Web_Development_2 {
    export class Director_Of_WebDevelopment_Chapter_12_3_Page_2_ReadPresalesScreenForAll_Handler_1_0 extends aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0 {
        //#region 1. Assign
        ...
        public async Action(): Promise<object> {
            ...
            const designPattern = new Use_DesignPattern_Builder_Chapter_12_3_Page_2(this.ClientOrServerInstance, this.MasterStorer, this.MasterDisturber, this.MasterSensor, this.StorylineDetails, this.StorylineDetails_Parameters, this.Repository, this.ExtraData, this.DirectorOrExperienceRequestHandler);
            //#endregion
    ...
    export class Use_DesignPattern_Builder_Chapter_12_3_Page_2 {
        //#region 1. Assign
        ...
        //#region 4. Action
        public async Action(): Promise<object> {
            const builder = new Implement_DesignPattern_Builder_Chapter_12_3_Page_2_1_0(this._clientORserverInstance, this._centralizedStorer, this._centralizedDisturber, this._centralizedSensor, this._storylineDetails, this._storylineDetails_Parameters, this._repository, this._extraData, this._entryPoint);
    ...
    export class Implement_DesignPattern_Builder_Chapter_12_3_Page_2_1_0 extends aClass_Programming_ScriptAction_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>
    {
        //#region 1. Assign
        private _centralizedStorer: aClass_Programming_ScriptAction_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>;
        private _centralizedDisturber: aClass_Programming_ScriptAction_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>;
        ...
        public async Action_5_Process_StorySetting(): Promise<object> {
            //region 1. Assign 
            var page = new ChapterPage_Page_2_5_Process_StorySetting_12_3_1_0.BaseDI.Professional.Chapter.Page.Web_Development_2.Page_2_5_Process_StorySetting_12_3_1_0(this._storylineDetails, this._repository);
        ...
        public async Action_9_Verify_Process(): Promise<object> {
            //#region 1. Assign 
            //var page = new ChapterPage_Page_2_9_Verify_Process_12_2_1_0.BaseDI.Professional.Chapter.Page.Programming_11.Page_2_9_Verify_Process_12_2_1_0(this._storylineDetails, this._repository);
        ...
        public async Action_10_End_Process(): Promise<object> {
            //#region 1. Assign 
            //var page = new ChapterPage_Page_2_10_End_Process_12_2_1_0.BaseDI.Professional.Chapter.Page.Programming_11.Page_2_10_End_Process_12_2_1_0(this._storylineDetails, this._repository);
