...
export namespace BaseDI.Professional.Director.Web_Development_3 {
    export class Director_Of_WebDevelopment_Chapter_12_3_Page_3_ReadOptinScreenForAll_Handler_1_0 extends aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0 {
        ...
        public async Action(): Promise<object> {
            ...
            const designPattern = new Use_DesignPattern_Builder_Chapter_12_3_Page_3(this.ClientOrServerInstance, this.MasterStorer, this.MasterDisturber, this.MasterSensor, this.StorylineDetails, this.StorylineDetails_Parameters, this.Repository, this.ExtraData, this.DirectorOrExperienceRequestHandler);
            //#endregion
    ...
    export class Implement_DesignPattern_Builder_Chapter_12_3_Page_3_1_0 extends aClass_Programming_ScriptAction_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>
    {
        ...
        {
            //region 1. Assign 
            var page = new ChapterPage_Page_3_5_Process_StorySetting_12_3_1_0.BaseDI.Professional.Chapter.Page.Web_Development_3.Page_3_5_Process_StorySetting_12_3_1_0(this._storylineDetails, this._repository);
        ...
        public async Action_9_Verify_Process(): Promise<object> {
            //#region 1. Assign 
            //var page = new ChapterPage_Page_3_9_Verify_Process_12_2_1_0.BaseDI.Professional.Chapter.Page.Programming_11.Page_3_9_Verify_Process_12_2_1_0(this._storylineDetails, this._repository);
        ...
        public async Action_10_End_Process(): Promise<object> {
            //#region 1. Assign 
            //var page = new ChapterPage_Page_3_10_End_Process_12_2_1_0.BaseDI.Professional.Chapter.Page.Programming_11.Page_3_10_End_Process_12_2_1_0(this._storylineDetails, this._repository);
