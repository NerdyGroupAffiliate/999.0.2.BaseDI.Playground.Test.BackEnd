...
export namespace BaseDI.BackEnd.Director.Web_Development_3 {
    export class Director_Of_WebDevelopment_Chapter_12_3_Page_3_ReadOptinScreenForAll_Handler_1_0 extends aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0.BaseDI.BackEnd.Programming.Abstract_1.aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0 {
        //#region 1. Assign
        ...
        public async Action(): Promise<object> {
            ...
            const designPattern = new Use_DesignPattern_Builder_Chapter_12_3_Page_3(this.ClientOrServerInstance, this.MasterStorer, this.MasterDisturber, this.MasterSensor, this.StorylineDetails, this.StorylineDetails_Parameters, this.Repository, this.ExtraData, this.EntryPoint);
            //#endregion
    ...
    export class Use_DesignPattern_Builder_Chapter_12_3_Page_3 {
        ...
        //#region 4. Action
        public async Action(): Promise<object> {
            const builder = new Implement_DesignPattern_Builder_Chapter_12_3_Page_3_1_0(this._clientORserverInstance, this._centralizedStorer, this._centralizedDisturber, this._centralizedSensor, this._storylineDetails, this._storylineDetails_Parameters, this._repository, this._extraData, this._entryPoint);
    ...
    export class Implement_DesignPattern_Builder_Chapter_12_3_Page_3_1_0 extends aClass_Programming_ScriptAction_12_2_1_0.BaseDI.BackEnd.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>
    {
        //#region 1. Assign
        private _centralizedStorer: aClass_Programming_ScriptAction_12_2_1_0.BaseDI.BackEnd.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>;
        private _centralizedDisturber: aClass_Programming_ScriptAction_12_2_1_0.BaseDI.BackEnd.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>;
        ...
        {
            //region 1. Assign 
            var page = new ChapterPage_Page_3_5_Process_StorySetting_12_3_1_0.BaseDI.BackEnd.Chapter.Page.Web_Development_3.Page_3_5_Process_StorySetting_12_3_1_0(this._storylineDetails, this._repository);
        ...
        public async Action_9_Verify_Process(): Promise<object> {
            //#region 1. Assign 
            //var page = new ChapterPage_Page_3_9_Verify_Process_12_2_1_0.BaseDI.BackEnd.Chapter.Page.Programming_11.Page_3_9_Verify_Process_12_2_1_0(this._storylineDetails, this._repository);
        ...
        public async Action_10_End_Process(): Promise<object> {
            //#region 1. Assign 
            //var page = new ChapterPage_Page_3_10_End_Process_12_2_1_0.BaseDI.BackEnd.Chapter.Page.Programming_11.Page_3_10_End_Process_12_2_1_0(this._storylineDetails, this._repository);
