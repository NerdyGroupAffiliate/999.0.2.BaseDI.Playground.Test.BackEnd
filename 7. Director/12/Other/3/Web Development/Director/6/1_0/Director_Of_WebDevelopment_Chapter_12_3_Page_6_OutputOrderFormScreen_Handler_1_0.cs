...
using ChapterPage = BaseDI.Professional.Chapter.Page.Web_Development_6;
...
namespace BaseDI.Professional.Director.Web_Development_6
{
    public class Director_Of_WebDevelopment_Chapter_12_3_Page_6_OutputOrderFormScreen_Handler_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        #region 1. Assign
        ...
        public Director_Of_WebDevelopment_Chapter_12_3_Page_6_OutputOrderFormScreen_Handler_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        public override async Task<JObject> Action()
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.TryAdd("parameterProcessRequestFileName", "Director_Of_WebDevelopment_Chapter_12_3_Page_6_OutputOrderFormScreen_Handler_1_0.cs");
            ...
            Use_DesignPattern_Builder_Chapter_12_3_Page_6 storedProcessRequestHandler_UsingBuilderPattern = null;
            ...
            try
            {
                ...
                storedProcessRequestHandler_UsingBuilderPattern = new Use_DesignPattern_Builder_Chapter_12_3_Page_6(_storedInputs);
    ...
    internal class Use_DesignPattern_Builder_Chapter_12_3_Page_6
    {
        #region 1. Assign
        ...
        internal Use_DesignPattern_Builder_Chapter_12_3_Page_6(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        internal async Task<JObject> Action()
        {
            ...
            storedProcessRequestHandler_UsingBuilderPattern = new Implement_DesignPattern_Builder_Chapter_12_3_Page_6_1_0(_storedInputs);
    ...
    internal class Implement_DesignPattern_Builder_Chapter_12_3_Page_6_1_0 : aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>
    {
        #region 1. Assign
        ...
        internal Implement_DesignPattern_Builder_Chapter_12_3_Page_6_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        private async Task<JObject> Execute_Factory_Action_5_Process_StorySetting_OutputHtml()
        {
            ...
            var page = new ChapterPage.Page_6_5_Process_StorySetting_12_3_1_0(_storedInputs);
