...
namespace BaseDI.Professional.Director.Web_Development_6
{
    public class Director_Of_WebDevelopment_Chapter_12_3_Page_6_ReadOrderFormScreenForAll_Handler_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        ...
        public Director_Of_WebDevelopment_Chapter_12_3_Page_6_ReadOrderFormScreenForAll_Handler_1_0()
        {
            #region 1. Assign            
        ...
        public override async Task<JObject> Action()
        {
            ...
            Use_DesignPattern_Builder_Chapter_12_3_Page_6 designPattern = new Use_DesignPattern_Builder_Chapter_12_3_Page_6(ClientOrServerInstance, MasterLeader, StorylineDetails, StorylineDetails_Parameters, (aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>)Repository, ExtraData, DirectorOrExperienceRequestHandler);
    ...
    internal class Use_DesignPattern_Builder_Chapter_12_3_Page_6
    {
        ...
        internal async Task<JObject> Action()
        {
            ...
            var builder = new Implement_DesignPattern_Builder_Chapter_12_3_Page_6_1_0(_clientORserverInstance, _centralizedStorer, _storylineDetails, _storylineDetails_Parameters, _repository, _extraData, _entryPoint);
    ...
    internal class Implement_DesignPattern_Builder_Chapter_12_3_Page_6_1_0 : aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>
    {
        ...
        internal Implement_DesignPattern_Builder_Chapter_12_3_Page_6_1_0(object clientORserverInstance, object centralizedStorer, JObject storylineDetails, JObject storylineDetails_Parameters, aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>> repository, ExtraData_12_2_1_0 extraData, aClass_Programming_ScriptRoutable_12_2_1_0 entryPoint = null)
        {
            _clientORserverInstance = clientORserverInstance;
            _centralizedStorer = centralizedStorer;
