...
{
    public class Director_Of_WebDevelopment_Chapter_12_3_Page_6_ReadOrderFormScreenForAll_Handler_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        #region 1. Assign
        ...
        public Director_Of_WebDevelopment_Chapter_12_3_Page_6_ReadOrderFormScreenForAll_Handler_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        public override async Task<JObject> Action()
        {
            ...
            Func<SingleParmPoco_12_2_1_0, Task<bool>> ValidateInputs = async (SingleParmPoco_12_2_1_0 parameterInputs) =>
            {
                ...
                storedProcessRequestDeveloperLoggingInputs.Parameters.Add("parameterProcessRequestFileName", "Director_Of_WebDevelopment_Chapter_12_3_Page_6_ReadOrderFormScreenForAll_Handler_1_0.cs");
            ...
            Use_DesignPattern_Builder_Chapter_12_3_Page_6 storedRequestHandler_UsingBuilderPattern = null;
            ...
            try
            {
                ...
                storedRequestHandler_UsingBuilderPattern = new Use_DesignPattern_Builder_Chapter_12_3_Page_6(_storedParameterInputs);
    ...
    internal class Use_DesignPattern_Builder_Chapter_12_3_Page_6
    {
        ...
        internal async Task<JObject> Action()
        {
            ...
            storedRequestHandler_UsingBuilderPattern = new Implement_DesignPattern_Builder_Chapter_12_3_Page_6_1_0(_storedParameterInputs);
    ...
    internal class Implement_DesignPattern_Builder_Chapter_12_3_Page_6_1_0 : aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>
    {
        ...
        private string _storedRequestFileName = "Director_Of_WebDevelopment_Chapter_12_3_Page_6_ReadOrderFormScreenForAll_Handler_1_0";
        private string _storedRequestName = "";
        private IContract_Programming_Repository_12_2_1_0 _storedRepository;
        private string _storedSystemRequestByName;
        ...
        private async Task<JObject> Execute_Factory_Action_5_Process_StorySetting_OutputHtml()
        {
            ...
            var page = new ChapterPage.Page_6_5_Process_StorySetting_12_3_1_0(_storedParameterInputs);
