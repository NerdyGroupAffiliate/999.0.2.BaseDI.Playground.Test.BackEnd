...
namespace BaseDI.Professional.Director.Web_Development_7
{
    public class Director_Of_WebDevelopment_Chapter_12_3_Page_7_OutputOTOScreen_Handler_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        ...
        public override async Task<JObject> Action()
        {
            ...
            Use_DesignPattern_Builder_Chapter_12_3_Page_7 storedRequestHandler_UsingBuilderPattern = null;
            ...
            try
            {
                ...
                storedRequestHandler_UsingBuilderPattern = new Use_DesignPattern_Builder_Chapter_12_3_Page_7(_storedParameterInputs);
    ...
    internal class Use_DesignPattern_Builder_Chapter_12_3_Page_7
    {
        ...
        internal async Task<JObject> Action()
        {
            ...
            storedRequestHandler_UsingBuilderPattern = new Implement_DesignPattern_Builder_Chapter_12_3_Page_7_1_0(_storedParameterInputs);
    ...
    internal class Implement_DesignPattern_Builder_Chapter_12_3_Page_7_1_0 : aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>
    {
        ...
        private string _storedRequestFileName = "Director_Of_WebDevelopment_Chapter_12_3_Page_7_OutputOTOScreen_Handler_1_0";
        private string _storedRequestName = "";
        private IContract_Programming_Repository_12_2_1_0 _storedRepository;
        private string _storedSystemRequestByName;
        ...
        private async Task<JObject> Execute_Factory_Action_5_Process_StorySetting_OutputHtml()
        {
            ...
            var page = new ChapterPage.Page_7_5_Process_StorySetting_12_3_1_0(_storedParameterInputs);
