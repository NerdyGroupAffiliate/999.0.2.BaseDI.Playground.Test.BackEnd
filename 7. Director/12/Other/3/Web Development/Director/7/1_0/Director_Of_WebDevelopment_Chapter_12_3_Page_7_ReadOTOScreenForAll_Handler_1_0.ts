...
export namespace BaseDI.Professional.Director.Web_Development_7 {
    ...
    export class Use_DesignPattern_Builder_Chapter_12_3_Page_7 {
        ...
        //#region 4. Action
        public async Action(): Promise<object> {
            const builder = new Implement_DesignPattern_Builder_Chapter_12_3_Page_7_1_0(this._clientORserverInstance, this._centralizedStorer, this._centralizedDisturber, this._centralizedSensor, this._storylineDetails, this._storylineDetails_Parameters, this._repository, this._extraData, this._entryPoint);
    ...
    export class Implement_DesignPattern_Builder_Chapter_12_3_Page_7_1_0 extends aClass_Programming_ScriptAction_12_2_1_0.BaseDI.Professional.Programming.Abstract_1.aClass_Programming_ScriptAction_12_2_1_0<object>
    {
        ...
        public async Action_5_Process_StorySetting(): Promise<object> {
            //region 1. Assign 
            var page = new ChapterPage_Page_7_5_Process_StorySetting_12_3_1_0.BaseDI.Professional.Chapter.Page.Web_Development_7.Page_7_5_Process_StorySetting_12_3_1_0(this._storylineDetails, this._repository);
