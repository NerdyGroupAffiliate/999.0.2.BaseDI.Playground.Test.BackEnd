...
using ChapterPage = BaseDI.Professional.Chapter.Page.Security_1;
...
namespace BaseDI.Professional.Director.Security_1
{
    public class Director_Of_Security_Chapter_12_5_Page_1_ReadAuthenticationForAll_Handler_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        ...
        public Director_Of_Security_Chapter_12_5_Page_1_ReadAuthenticationForAll_Handler_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        public override async Task<JObject> Action()
        {
            ...
            Use_DesignPattern_Builder_Chapter_12_5_Page_1 storedProcessRequestHandler_UsingBuilderPattern = null;
            ...
            try
            {
                ...
                storedProcessRequestHandler_UsingBuilderPattern = new Use_DesignPattern_Builder_Chapter_12_5_Page_1(_storedInputs);
    ...
    internal class Use_DesignPattern_Builder_Chapter_12_5_Page_1
    {
        #region 1. Assign
        ...
        internal Use_DesignPattern_Builder_Chapter_12_5_Page_1(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        internal async Task<JObject> Action()
        {
            ...
            storedProcessRequestHandler_UsingBuilderPattern = new Implement_DesignPattern_Builder_Chapter_12_5_Page_1_1_0(_storedInputs);
    ...
    internal class Implement_DesignPattern_Builder_Chapter_12_5_Page_1_1_0 : aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>
    {
        #region 1. Assign
        ...
        private string _storedProcessRequestFileName = "Director_Of_Security_Chapter_12_5_Page_1_ReadAuthenticationForAll_Handler_1_0";
        private string _storedProcessRequestName = "";
        private IContract_Programming_Repository_12_2_1_0 _storedProcessRequestDataRepository;
        private string _storedProcessRequestSystemRequestByName;
        ...
        internal Implement_DesignPattern_Builder_Chapter_12_5_Page_1_1_0(SingleParmPoco_12_2_1_0 parameterInputs)
        {
            #region 1. INPUTS
        ...
        //Page 1-9
        private async Task<JObject> Execute_Factory_Action_9_Verify_Process_OutputApiToken()
        {
            #region 1. INPUTS
            ...
            var page = new ChapterPage.Page_1_9_Verify_Process_12_5_1_0(_storedInputs);
