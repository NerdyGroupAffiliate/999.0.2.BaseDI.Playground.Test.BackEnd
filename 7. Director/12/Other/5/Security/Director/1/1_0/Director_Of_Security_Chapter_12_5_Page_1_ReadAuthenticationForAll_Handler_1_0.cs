...
namespace BaseDI.Professional.Director.Security_1
{
    public class Director_Of_Security_Chapter_12_5_Page_1_ReadAuthenticationForAll_Handler_1_0 : aClass_Programming_ScriptDirector_BuilderPattern_12_2_1_0
    {
        ...
        public override async Task<JObject> Action()
        {
            ...
            Use_DesignPattern_Builder_Chapter_12_5_Page_1 storedRequestHandler_UsingBuilderPattern = null;
            ...
            try
            {
                ...
                storedRequestHandler_UsingBuilderPattern = new Use_DesignPattern_Builder_Chapter_12_5_Page_1(_storedParameterInputs);
    ...
    internal class Use_DesignPattern_Builder_Chapter_12_5_Page_1
    {
        ...
        internal async Task<JObject> Action()
        {
            ...
            storedRequestHandler_UsingBuilderPattern = new Implement_DesignPattern_Builder_Chapter_12_5_Page_1_1_0(_storedParameterInputs);
    ...
    internal class Implement_DesignPattern_Builder_Chapter_12_5_Page_1_1_0 : aClass_Programming_ScriptAction_12_2_1_0<Task<JObject>>
    {
        ...
        private string _storedRequestFileName = "Director_Of_Security_Chapter_12_5_Page_1_ReadAuthenticationForAll_Handler_1_0";
        private string _storedRequestName = "";
        private IContract_Programming_Repository_12_2_1_0 _storedRepository;
        private string _storedSystemRequestByName;
        ...
        private async Task<JObject> Execute_Factory_Action_9_Verify_Process_OutputApiToken()
        {
            ...
            var page = new ChapterPage.Page_1_9_Verify_Process_12_5_1_0(_storedParameterInputs);
