...
const ExecuteConversionRequest = async (parameterInputs: SingleParmPoco_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.SingleParmPoco_12_2_1_0): Promise<any> => {
    ...
    let storedProcessRequestConverter: ChapterPage_Page_2_5_Process_StorySetting_12_2_1_0.BaseDI.Professional.Chapter.Page.Programming_2.Page_2_5_Process_StorySetting_12_2_1_0;
    ...
    storedProcessRequestConverter = new ChapterPage_Page_2_5_Process_StorySetting_12_2_1_0.BaseDI.Professional.Chapter.Page.Programming_2.Page_2_5_Process_StorySetting_12_2_1_0(parameterInputs);
...
describe('Conversion Test', () => {
    test.only('1. Conversion Test - Convert HTML to JSON', async () =>
    {
        ...
        //1. INPUTS
        storedInputs.Parameters.setValue("parameterInputRequestActionName", Action_12_2_1_0.BaseDI.Professional.Script.Programming.Poco_1.Action_12_2_1_0._12_3_WEB_DEVELOPMENT_Server_Process_HtmlToJsonConversion_Request_1_0);
