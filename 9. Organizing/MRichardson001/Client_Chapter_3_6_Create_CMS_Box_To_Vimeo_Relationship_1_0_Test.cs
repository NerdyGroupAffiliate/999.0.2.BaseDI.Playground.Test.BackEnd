...
namespace BaseDI.BackEnd
{
    public class Client_Chapter_3_6_Create_CMS_Box_To_Vimeo_Relationship_1_0_Test
    {
        ...
        //[Test]
        //public void Chapter_3_6_Can_Download_From_Box_and_Upload_Video_to_Vimeo()
        //{
        //    #region 1. Variables
        ...
        //    using (var BoxClient = new DropboxClient("f_QLvJGpSFAAAAAAAAAAEqa-twrzZnKWBpVVhoDOnhGhuf_ARHAM0wKEcYeWfUmP", new DropboxClientConfig("Vimeo Agent")))
        //    {
