...
class ListAmenitiesWithGalleryView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/ListAmenitiesWithGalleryController')
      ...
      if (e.code == 'MODULE_NOT_FOUND') {
        Controller = ListAmenitiesWithGalleryView
  ...
  render() {
    const proxies = Controller !== ListAmenitiesWithGalleryView ? transformProxies(this.props.children) : {
      'header-container': [],
      'subtitle': [],
      'title': [],
      'gallery': [],
    ...
    return (
      <React.Fragment>
        ...
        <span className="af-view" style={{width: '100%', height: '100%', flex: 1}}>
          <div className="af-class-list-amenities-w-gallery">
            {map(proxies['header-container'], props => <div {...{...props, className: `af-class-amenity-slider-heading ${props.className || ''}`}}>{createScope(props.children, proxies => <React.Fragment>
                        {props.topelement ? props.topelement() : null}

              <div className="af-class-div-block-160">
                {map(proxies['subtitle'], props => <h2 {...{...props, className: `af-class-section-title af-class-white ${props.className || ''}`}}>{props.children ? props.children : <React.Fragment>Community amenities</React.Fragment>}</h2>)}
            ...
            <div className="af-class-div-block-159">
...
export default ListAmenitiesWithGalleryView
