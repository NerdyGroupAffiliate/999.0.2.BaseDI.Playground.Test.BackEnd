...
class UnitGridPaymentBreakdownEntryView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/UnitGridPaymentBreakdownEntryController')
      ...
      if (e.code == 'MODULE_NOT_FOUND') {
        Controller = UnitGridPaymentBreakdownEntryView
  ...
  render() {
    const proxies = Controller !== UnitGridPaymentBreakdownEntryView ? transformProxies(this.props.children) : {
      'title': [],
      'value': [],
    }
...
export default UnitGridPaymentBreakdownEntryView
